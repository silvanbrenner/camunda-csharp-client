...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class AuthorizationDto : IEquatable<AuthorizationDto>, IValidatableObject
    {
        ...
        /// <param name="type">The type of the authorization (0&#x3D;global, 1&#x3D;grant, 2&#x3D;revoke). See the [User Guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/authorization-service.md#authorization-type) for more information about authorization types..</param>
        ...
        /// <param name="resourceType">An integer representing the resource type. See the [User Guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/authorization-service/#resources) for a list of integer representations of resource types..</param>
        ...
        public AuthorizationDto(string id = default(string), int? type = default(int?), List<string> permissions = default(List<string>), string userId = default(string), string groupId = default(string), int? resourceType = default(int?), string resourceId = default(string), DateTime? removalTime = default(DateTime?), string rootProcessInstanceId = default(string))
        {
            this.Id = id;
            this.Type = type;
        ...
        /// </summary>
        /// <value>The type of the authorization (0&#x3D;global, 1&#x3D;grant, 2&#x3D;revoke). See the [User Guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/authorization-service.md#authorization-type) for more information about authorization types.</value>
        ...
        /// </summary>
        /// <value>An integer representing the resource type. See the [User Guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/authorization-service/#resources) for a list of integer representations of resource types.</value>
