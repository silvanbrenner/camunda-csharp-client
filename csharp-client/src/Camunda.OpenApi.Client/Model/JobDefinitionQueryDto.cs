...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class JobDefinitionQueryDto : IEquatable<JobDefinitionQueryDto>, IValidatableObject
    {
        ...
        /// <param name="jobType">Only include job definitions which exist for the given job type. See the [User Guide](https://docs.camunda.org/manual/7.17/user-guide/process-engine/the-job-executor/#job-creation) for more information about job types..</param>
        ...
        /// </summary>
        /// <value>Only include job definitions which exist for the given job type. See the [User Guide](https://docs.camunda.org/manual/7.17/user-guide/process-engine/the-job-executor/#job-creation) for more information about job types.</value>
