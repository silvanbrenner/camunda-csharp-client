...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class CommentDto : IEquatable<CommentDto>, IValidatableObject
    {
        ...
        public CommentDto(string id = default(string), string userId = default(string), string taskId = default(string), string processInstanceId = default(string), DateTime? time = default(DateTime?), string message = default(string), DateTime? removalTime = default(DateTime?), string rootProcessInstanceId = default(string), List<AtomLink> links = default(List<AtomLink>))
        {
            this.Id = id;
            this.UserId = userId;
            this.TaskId = taskId;
