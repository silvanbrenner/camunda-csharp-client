...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class DecisionDefinitionDto : IEquatable<DecisionDefinitionDto>, IValidatableObject
    {
        ...
        /// <param name="historyTimeToLive">History time to live value of the decision definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.17/user-guide/process-engine/history/#history-cleanup)..</param>
        ...
        /// </summary>
        /// <value>History time to live value of the decision definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.17/user-guide/process-engine/history/#history-cleanup).</value>
