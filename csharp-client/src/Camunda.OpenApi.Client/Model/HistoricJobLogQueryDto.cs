...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class HistoricJobLogQueryDto : IEquatable<HistoricJobLogQueryDto>, IValidatableObject
    {
        ...
        /// <param name="jobDefinitionType">Filter by job definition type. See the [User Guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/the-job-executor/#job-creation) for more information about job definition types..</param>
        ...
        /// </summary>
        /// <value>Filter by job definition type. See the [User Guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/the-job-executor/#job-creation) for more information about job definition types.</value>
