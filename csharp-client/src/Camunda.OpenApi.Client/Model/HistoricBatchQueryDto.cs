...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class HistoricBatchQueryDto : IEquatable<HistoricBatchQueryDto>, IValidatableObject
    {
        ...
        /// <param name="type">Filter by batch type. See the [User Guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/batch/#creating-a-batch) for more information about batch types..</param>
        ...
        /// </summary>
        /// <value>Filter by batch type. See the [User Guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/batch/#creating-a-batch) for more information about batch types.</value>
