...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class JobDefinitionDto : IEquatable<JobDefinitionDto>, IValidatableObject
    {
        ...
        /// <param name="jobType">The type of the job which is running for this job definition. See the [User Guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/the-job-executor/#job-creation) for more information about job types..</param>
        ...
        /// </summary>
        /// <value>The type of the job which is running for this job definition. See the [User Guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/the-job-executor/#job-creation) for more information about job types.</value>
