...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class CaseDefinitionDto : IEquatable<CaseDefinitionDto>, IValidatableObject
    {
        ...
        /// <param name="historyTimeToLive">History time to live value of the case definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.17/user-guide/process-engine/history/#history-cleanup)..</param>
        ...
        /// </summary>
        /// <value>History time to live value of the case definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.17/user-guide/process-engine/history/#history-cleanup).</value>
