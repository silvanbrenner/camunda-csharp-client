...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class BatchStatisticsDto : IEquatable<BatchStatisticsDto>, IValidatableObject
    {
        ...
        /// <param name="type">The type of the batch. See the [User Guide](https://docs.camunda.org/manual/7.15/user-guide/process-engine/batch/#creating-a-batch) for more information about batch types..</param>
        ...
        /// <summary>
        /// The type of the batch. See the [User Guide](https://docs.camunda.org/manual/7.15/user-guide/process-engine/batch/#creating-a-batch) for more information about batch types.
        /// </summary>
        /// <value>The type of the batch. See the [User Guide](https://docs.camunda.org/manual/7.15/user-guide/process-engine/batch/#creating-a-batch) for more information about batch types.</value>
