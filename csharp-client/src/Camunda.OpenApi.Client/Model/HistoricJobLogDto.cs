...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class HistoricJobLogDto : IEquatable<HistoricJobLogDto>, IValidatableObject
    {
        ...
        /// <param name="removalTime">The time after which the log entry should be removed by the History Cleanup job. Default format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;. For further info see the [docs](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/).</param>
        ...
        /// <param name="jobDefinitionType">The job definition type of the associated job. See the [User Guide](https://docs.camunda.org/manual/7.17/user-guide/process-engine/the-job-executor/#job-creation) for more information about job definition types..</param>
        ...
        /// </summary>
        /// <value>The time after which the log entry should be removed by the History Cleanup job. Default format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;. For further info see the [docs](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/)</value>
        ...
        /// </summary>
        /// <value>The job definition type of the associated job. See the [User Guide](https://docs.camunda.org/manual/7.17/user-guide/process-engine/the-job-executor/#job-creation) for more information about job definition types.</value>
