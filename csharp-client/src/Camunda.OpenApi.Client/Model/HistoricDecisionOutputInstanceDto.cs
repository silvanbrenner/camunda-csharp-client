...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class HistoricDecisionOutputInstanceDto : IEquatable<HistoricDecisionOutputInstanceDto>, IValidatableObject
    {
        ...
        /// <param name="removalTime">The time after which the entry should be removed by the History Cleanup job. [Default format](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/) &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;..</param>
        ...
        public HistoricDecisionOutputInstanceDto(string id = default(string), string decisionInstanceId = default(string), string clauseId = default(string), string clauseName = default(string), string ruleId = default(string), int? ruleOrder = default(int?), string errorMessage = default(string), string variableName = default(string), string type = default(string), DateTime? createTime = default(DateTime?), DateTime? removalTime = default(DateTime?), string rootProcessInstanceId = default(string), Object value = default(Object), Dictionary<string, Object> valueInfo = default(Dictionary<string, Object>))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>The time after which the entry should be removed by the History Cleanup job. [Default format](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/) &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;.</value>
