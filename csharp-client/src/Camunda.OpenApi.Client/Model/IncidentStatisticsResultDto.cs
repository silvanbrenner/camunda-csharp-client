...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class IncidentStatisticsResultDto : IEquatable<IncidentStatisticsResultDto>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="incidentType">The type of the incident the number of incidents is aggregated for. See the [User Guide](https://docs.camunda.org/manual/7.14/user-guide/process-engine/incidents/#incident-types) for a list of incident types..</param>
        ...
        /// </summary>
        /// <value>The type of the incident the number of incidents is aggregated for. See the [User Guide](https://docs.camunda.org/manual/7.14/user-guide/process-engine/incidents/#incident-types) for a list of incident types.</value>
