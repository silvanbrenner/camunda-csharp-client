...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class JobDefinitionsSuspensionStateDtoAllOf : IEquatable<JobDefinitionsSuspensionStateDtoAllOf>, IValidatableObject
    {
        ...
        public JobDefinitionsSuspensionStateDtoAllOf(string processDefinitionId = default(string), string processDefinitionKey = default(string), string processDefinitionTenantId = default(string), bool? processDefinitionWithoutTenantId = default(bool?))
        {
