...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class CommentDtoAllOf : IEquatable<CommentDtoAllOf>, IValidatableObject
    {
        ...
        public CommentDtoAllOf(string id = default(string), string userId = default(string), string taskId = default(string), string processInstanceId = default(string), DateTime? time = default(DateTime?), string message = default(string), DateTime? removalTime = default(DateTime?), string rootProcessInstanceId = default(string))
        {
            this.Id = id;
            this.UserId = userId;
            this.TaskId = taskId;
