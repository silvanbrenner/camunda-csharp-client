...
namespace Camunda.OpenApi.Client.Model
{
    ...
    public partial class FetchExternalTasksDto : IEquatable<FetchExternalTasksDto>, IValidatableObject
    {
        ...
        /// <param name="asyncResponseTimeout">The [Long Polling](https://docs.camunda.org/manual/7.15/user-guide/process-engine/external-tasks/#long-polling-to-fetch-and-lock-external-tasks) timeout in milliseconds.  **Note:** The value cannot be set larger than 1.800.000 milliseconds (corresponds to 30 minutes)..</param>
        ...
        /// <summary>
        /// The [Long Polling](https://docs.camunda.org/manual/7.15/user-guide/process-engine/external-tasks/#long-polling-to-fetch-and-lock-external-tasks) timeout in milliseconds.  **Note:** The value cannot be set larger than 1.800.000 milliseconds (corresponds to 30 minutes).
        /// </summary>
        /// <value>The [Long Polling](https://docs.camunda.org/manual/7.15/user-guide/process-engine/external-tasks/#long-polling-to-fetch-and-lock-external-tasks) timeout in milliseconds.  **Note:** The value cannot be set larger than 1.800.000 milliseconds (corresponds to 30 minutes).</value>
