...
namespace Camunda.OpenApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CalledProcessDefinitionDto")]
    public partial class CalledProcessDefinitionDto : IEquatable<CalledProcessDefinitionDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CalledProcessDefinitionDto" /> class.
        /// </summary>
        ...
        /// <param name="historyTimeToLive">History time to live value of the process definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.17/user-guide/process-engine/history/#history-cleanup)..</param>
        /// <param name="startableInTasklist">A flag indicating whether the process definition is startable in Tasklist or not..</param>
        public CalledProcessDefinitionDto(List<string> calledFromActivityIds = default(List<string>), string callingProcessDefinitionId = default(string), string id = default(string), string key = default(string), string category = default(string), string description = default(string), string name = default(string), int? version = default(int?), string resource = default(string), string deploymentId = default(string), string diagram = default(string), bool? suspended = default(bool?), string tenantId = default(string), string versionTag = default(string), int? historyTimeToLive = default(int?), bool? startableInTasklist = default(bool?))
        {
        ...
        /// </summary>
        /// <value>History time to live value of the process definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.17/user-guide/process-engine/history/#history-cleanup).</value>
        ...
        {
            return this.Equals(input as CalledProcessDefinitionDto);
        }

        /// <summary>
        /// Returns true if CalledProcessDefinitionDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CalledProcessDefinitionDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CalledProcessDefinitionDto input)
        {
            if (input == null)
                return false;
