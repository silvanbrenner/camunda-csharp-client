...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public interface IVariableInstanceApiSync : IApiAccessor
    {
        ...
        ApiResponse<FileParameter> GetVariableInstanceBinaryWithHttpInfo(string id);
        /// <summary>
    ...
    public interface IVariableInstanceApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<FileParameter> GetVariableInstanceBinaryAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<FileParameter>> GetVariableInstanceBinaryWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get Variable Instances
        /// </summary>
        /// <remarks>
    ...
    public partial class VariableInstanceApi : IDisposable, IVariableInstanceApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public VariableInstanceApi(HttpClient client, Camunda.OpenApi.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="id">The id of the variable instance.</param>
        /// <returns>FileParameter</returns>
        public FileParameter GetVariableInstanceBinary(string id)
        {
            Camunda.OpenApi.Client.Client.ApiResponse<FileParameter> localVarResponse = GetVariableInstanceBinaryWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the variable instance.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<FileParameter> GetVariableInstanceBinaryWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<FileParameter>("/variable-instance/{id}/data", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FileParameter</returns>
        public async System.Threading.Tasks.Task<FileParameter> GetVariableInstanceBinaryAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Camunda.OpenApi.Client.Client.ApiResponse<FileParameter> localVarResponse = await GetVariableInstanceBinaryWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<FileParameter>> GetVariableInstanceBinaryWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling VariableInstanceApi->GetVariableInstanceBinary");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<FileParameter>("/variable-instance/{id}/data", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Get Variable Instance Count Query for the number of variable instances that fulfill given parameters. Takes the same parameters as the [Get Variable Instances](https://docs.camunda.org/manual/7.17/reference/rest/variable-instance/get-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="variableName">Filter by variable instance name. (optional)</param>
        /// <param name="variableNameLike">Filter by the variable instance name. The parameter can include the wildcard &#x60;%&#x60; to express like-strategy such as: starts with (&#x60;%&#x60;name), ends with (name&#x60;%&#x60;) or contains (&#x60;%&#x60;name&#x60;%&#x60;). (optional)</param>
