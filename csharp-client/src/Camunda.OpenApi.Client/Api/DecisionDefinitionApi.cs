...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public partial class DecisionDefinitionApi : IDecisionDefinitionApi
    {
        ...
        /// <summary>
        /// Get List Count Requests the number of decision definitions that fulfill the query criteria. Takes the same filtering parameters as the [Get Decision Definition](https://docs.camunda.org/manual/7.15/reference/rest/decision-definition/get-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="decisionDefinitionId">Filter by decision definition id. (optional)</param>
        /// <param name="decisionDefinitionIdIn">Filter by decision definition ids. (optional)</param>
        ...
        /// <summary>
        /// Update History Time to Live Updates history time to live for decision definition. The field is used within [History cleanup](https://docs.camunda.org/manual/7.15/user-guide/process-engine/history/#history-cleanup).
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The id of the decision definition to change history time to live.</param>
        /// <param name="historyTimeToLiveDto"> (optional)</param>
        ...
        /// <summary>
        /// Update History Time to Live By Key Updates the latest version of the decision definition which belongs to no tenant. The field is used within [History cleanup](https://docs.camunda.org/manual/7.15/user-guide/process-engine/history/#history-cleanup).
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="key">The key of the decision definitions to change history time to live.</param>
        /// <param name="historyTimeToLiveDto"> (optional)</param>
        ...
        /// <summary>
        /// Update History Time to Live By Key And Tenant Updates the latest version of the decision definition for tenant. The field is used within [History cleanup](https://docs.camunda.org/manual/7.15/user-guide/process-engine/history/#history-cleanup).
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="key">The key of the decision definitions to change history time to live.</param>
        /// <param name="tenantId">The id of the tenant the decision definition belongs to.</param>
