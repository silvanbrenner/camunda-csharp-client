...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public interface IDeploymentApiSync : IApiAccessor
    {
        ...
        /// <param name="after">Restricts to all deployments after the given date. By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <param name="before">Restricts to all deployments before the given date. By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        ...
        ApiResponse<List<string>> GetRegisteredDeploymentsWithHttpInfo();
        /// <summary>
        /// Redeploy
        /// </summary>
        /// <remarks>
    ...
    public interface IDeploymentApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<string>> GetRegisteredDeploymentsAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<string>>> GetRegisteredDeploymentsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Redeploy
        /// </summary>
        /// <remarks>
    ...
    public partial class DeploymentApi : IDisposable, IDeploymentApi
    {
        ...
        public Camunda.OpenApi.Client.Client.ApiResponse<DeploymentWithDefinitionsDto> CreateDeploymentWithHttpInfo(string tenantId = default(string), string deploymentSource = default(string), bool? deployChangedOnly = default(bool?), bool? enableDuplicateFiltering = default(bool?), string deploymentName = default(string), DateTime? deploymentActivationTime = default(DateTime?), FileParameter data = default(FileParameter))
        {
            ...
            {
                localVarRequestOptions.FormParameters.Add("deployment-activation-time", Camunda.OpenApi.Client.Client.ClientUtils.ParameterToString(deploymentActivationTime)); // form parameter
            }
            if (data != null)
            {
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<DeploymentDto> localVarResponse = GetDeploymentWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the deployment.</param>
        /// <returns>ApiResponse of DeploymentDto</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<DeploymentDto> GetDeploymentWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<DeploymentDto> localVarResponse = await GetDeploymentWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeploymentDto)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<DeploymentDto>> GetDeploymentWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling DeploymentApi->GetDeployment");
        ...
        /// <summary>
        /// Get List Count Queries for the number of deployments that fulfill given parameters. Takes the same parameters as the [Get Deployments](https://docs.camunda.org/manual/7.17/reference/rest/deployment/get-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Filter by deployment id (optional)</param>
        /// <param name="name">Filter by the deployment name. Exact match. (optional)</param>
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<List<string>> localVarResponse = GetRegisteredDeploymentsWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<List<string>> GetRegisteredDeploymentsWithHttpInfo()
        {
            Camunda.OpenApi.Client.Client.RequestOptions localVarRequestOptions = new Camunda.OpenApi.Client.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<string>>("/deployment/registered", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetRegisteredDeployments", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;string&gt;</returns>
        public async System.Threading.Tasks.Task<List<string>> GetRegisteredDeploymentsAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Camunda.OpenApi.Client.Client.ApiResponse<List<string>> localVarResponse = await GetRegisteredDeploymentsWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<List<string>>> GetRegisteredDeploymentsWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<string>>("/deployment/registered", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
