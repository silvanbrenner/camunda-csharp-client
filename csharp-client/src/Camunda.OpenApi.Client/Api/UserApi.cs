...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public interface IUserApiSync : IApiAccessor
    {
        ...
        /// <returns></returns>
        void UpdateCredentials(string id, UserCredentialsDto userCredentialsDto = default(UserCredentialsDto));
        ...
        /// <param name="userCredentialsDto"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> UpdateCredentialsWithHttpInfo(string id, UserCredentialsDto userCredentialsDto = default(UserCredentialsDto));
        /// <summary>
        /// Update User Profile
        /// </summary>
        /// <remarks>
    ...
    public interface IUserApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task UpdateCredentialsAsync(string id, UserCredentialsDto userCredentialsDto = default(UserCredentialsDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> UpdateCredentialsWithHttpInfoAsync(string id, UserCredentialsDto userCredentialsDto = default(UserCredentialsDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Update User Profile
        /// </summary>
        /// <remarks>
    ...
    public partial class UserApi : IDisposable, IUserApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public UserApi(HttpClient client, Camunda.OpenApi.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <summary>
        /// Get List Count Queries for the number of deployments that fulfill given parameters. Takes the same parameters as the [Get Users](https://docs.camunda.org/manual/7.16/reference/rest/user/get-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Filter by user id (optional)</param>
        /// <param name="idIn">Filter by a comma-separated list of user ids. (optional)</param>
        ...
        /// <summary>
        /// Get List Query for a list of users using a list of parameters. The size of the result set can be retrieved by using the Get User Count method. [Get User Count](https://docs.camunda.org/manual/7.16/reference/rest/user/get-query-count/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">Filter by user id (optional)</param>
        /// <param name="idIn">Filter by a comma-separated list of user ids. (optional)</param>
        ...
        /// <param name="userCredentialsDto"> (optional)</param>
        /// <returns></returns>
        public void UpdateCredentials(string id, UserCredentialsDto userCredentialsDto = default(UserCredentialsDto))
        {
        ...
        /// <param name="userCredentialsDto"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<Object> UpdateCredentialsWithHttpInfo(string id, UserCredentialsDto userCredentialsDto = default(UserCredentialsDto))
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task UpdateCredentialsAsync(string id, UserCredentialsDto userCredentialsDto = default(UserCredentialsDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await UpdateCredentialsWithHttpInfoAsync(id, userCredentialsDto, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<Object>> UpdateCredentialsWithHttpInfoAsync(string id, UserCredentialsDto userCredentialsDto = default(UserCredentialsDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling UserApi->UpdateCredentials");
