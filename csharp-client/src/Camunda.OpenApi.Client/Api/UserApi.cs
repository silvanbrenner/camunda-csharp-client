...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public partial class UserApi : IUserApi
    {
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<List<UserProfileDto>> localVarResponse = GetUserProfileWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the user to retrieve.</param>
        /// <returns>ApiResponse of List&lt;UserProfileDto&gt;</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<List<UserProfileDto>> GetUserProfileWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<List<UserProfileDto>> localVarResponse = await GetUserProfileWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;UserProfileDto&gt;)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<List<UserProfileDto>>> GetUserProfileWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling UserApi->GetUserProfile");
