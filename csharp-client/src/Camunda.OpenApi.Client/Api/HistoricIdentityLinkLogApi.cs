...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public partial class HistoricIdentityLinkLogApi : IDisposable, IHistoricIdentityLinkLogApi
    {
        ...
        /// <summary>
        /// Get Identity Link Logs Queries for historic identity link logs that fulfill given parameters. The size of the result set can be retrieved by using the [Get Identity-Link-Log Count](https://docs.camunda.org/manual/7.17/reference/rest/history/identity-links/get-identity-link-query-count/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="type">Restricts to identity links that have the given type (candidate/assignee/owner). (optional)</param>
        /// <param name="userId">Restricts to identity links that have the given user id. (optional)</param>
        ...
        /// <summary>
        /// Get Identity Link Log Count Queries for the number of historic identity link logs that fulfill the given parameters. Takes the same parameters as the [Get Identity-Link-Logs](https://docs.camunda.org/manual/7.17/reference/rest/history/identity-links/get-identity-link-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="type">Restricts to identity links that have the given type (candidate/assignee/owner). (optional)</param>
        /// <param name="userId">Restricts to identity links that have the given user id. (optional)</param>
