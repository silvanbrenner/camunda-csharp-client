...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public interface IHistoricVariableInstanceApiSync : IApiAccessor
    {
        ...
        ApiResponse<FileParameter> GetHistoricVariableInstanceBinaryWithHttpInfo(string id);
        /// <summary>
        ...
        /// <param name="variableNameIn">Only include historic variable instances which belong to one of the passed and comma-separated variable names. (optional)</param>
        ...
        CountResultDto GetHistoricVariableInstancesCount(string variableName = default(string), string variableNameLike = default(string), Object variableValue = default(Object), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?), string variableTypeIn = default(string), bool? includeDeleted = default(bool?), string processInstanceId = default(string), string processInstanceIdIn = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string executionIdIn = default(string), string caseInstanceId = default(string), string caseExecutionIdIn = default(string), string caseActivityIdIn = default(string), string taskIdIn = default(string), string activityInstanceIdIn = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), string variableNameIn = default(string));
    ...
    public interface IHistoricVariableInstanceApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<FileParameter> GetHistoricVariableInstanceBinaryAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<FileParameter>> GetHistoricVariableInstanceBinaryWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get Variable Instances
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<CountResultDto> GetHistoricVariableInstancesCountAsync(string variableName = default(string), string variableNameLike = default(string), Object variableValue = default(Object), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?), string variableTypeIn = default(string), bool? includeDeleted = default(bool?), string processInstanceId = default(string), string processInstanceIdIn = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string executionIdIn = default(string), string caseInstanceId = default(string), string caseExecutionIdIn = default(string), string caseActivityIdIn = default(string), string taskIdIn = default(string), string activityInstanceIdIn = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), string variableNameIn = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class HistoricVariableInstanceApi : IDisposable, IHistoricVariableInstanceApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public HistoricVariableInstanceApi(HttpClient client, Camunda.OpenApi.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="id">The id of the variable instance.</param>
        /// <returns>FileParameter</returns>
        public FileParameter GetHistoricVariableInstanceBinary(string id)
        {
            Camunda.OpenApi.Client.Client.ApiResponse<FileParameter> localVarResponse = GetHistoricVariableInstanceBinaryWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the variable instance.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<FileParameter> GetHistoricVariableInstanceBinaryWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<FileParameter>("/history/variable-instance/{id}/data", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FileParameter</returns>
        public async System.Threading.Tasks.Task<FileParameter> GetHistoricVariableInstanceBinaryAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Camunda.OpenApi.Client.Client.ApiResponse<FileParameter> localVarResponse = await GetHistoricVariableInstanceBinaryWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<FileParameter>> GetHistoricVariableInstanceBinaryWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling HistoricVariableInstanceApi->GetHistoricVariableInstanceBinary");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<FileParameter>("/history/variable-instance/{id}/data", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Get Variable Instances Queries for historic variable instances that fulfill the given parameters. The size of the result set can be retrieved by using the [Get Variable Instance Count](https://docs.camunda.org/manual/7.17/reference/rest/history/variable-instance/get-variable-instance-query-count/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="variableName">Filter by variable name. (optional)</param>
        /// <param name="variableNameLike">Restrict to variables with a name like the parameter. (optional)</param>
        ...
        public Camunda.OpenApi.Client.Client.ApiResponse<List<HistoricVariableInstanceDto>> GetHistoricVariableInstancesWithHttpInfo(string variableName = default(string), string variableNameLike = default(string), Object variableValue = default(Object), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?), string variableTypeIn = default(string), bool? includeDeleted = default(bool?), string processInstanceId = default(string), string processInstanceIdIn = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string executionIdIn = default(string), string caseInstanceId = default(string), string caseExecutionIdIn = default(string), string caseActivityIdIn = default(string), string taskIdIn = default(string), string activityInstanceIdIn = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), string variableNameIn = default(string), string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?), bool? deserializeValues = default(bool?))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "variableNameIn", variableNameIn));
            }
            if (sortBy != null)
            {
        ...
        /// <summary>
        /// Get Variable Instance Count Queries for the number of historic variable instances that fulfill the given parameters. Takes the same parameters as the [Get Variable Instances](https://docs.camunda.org/manual/7.17/reference/rest/history/variable-instance/get-variable-instance-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="variableName">Filter by variable name. (optional)</param>
        /// <param name="variableNameLike">Restrict to variables with a name like the parameter. (optional)</param>
