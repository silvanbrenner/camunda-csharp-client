...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public partial class HistoricProcessInstanceApi : IHistoricProcessInstanceApi
    {
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<Object> localVarResponse = GetHistoricProcessInstanceDurationReportWithHttpInfo(reportType, periodUnit, processDefinitionIdIn, processDefinitionKeyIn, startedBefore, startedAfter);
            return localVarResponse.Data;
        }
        ...
        /// <param name="startedAfter">Restrict to instances that were started after the given date. By [default](https://docs.camunda.org/manual/7.14/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2016-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <returns>ApiResponse of Object</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<Object> GetHistoricProcessInstanceDurationReportWithHttpInfo(string reportType, string periodUnit, string processDefinitionIdIn = default(string), string processDefinitionKeyIn = default(string), DateTime? startedBefore = default(DateTime?), DateTime? startedAfter = default(DateTime?))
        {
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<Object> localVarResponse = await GetHistoricProcessInstanceDurationReportWithHttpInfoAsync(reportType, periodUnit, processDefinitionIdIn, processDefinitionKeyIn, startedBefore, startedAfter, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<Object>> GetHistoricProcessInstanceDurationReportWithHttpInfoAsync(string reportType, string periodUnit, string processDefinitionIdIn = default(string), string processDefinitionKeyIn = default(string), DateTime? startedBefore = default(DateTime?), DateTime? startedAfter = default(DateTime?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'reportType' is set
            if (reportType == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'reportType' when calling HistoricProcessInstanceApi->GetHistoricProcessInstanceDurationReport");
