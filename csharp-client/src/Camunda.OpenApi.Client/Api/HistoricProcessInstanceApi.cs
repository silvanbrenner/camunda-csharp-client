...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public interface IHistoricProcessInstanceApiSync : IApiAccessor
    {
        ...
        /// <param name="startedAfter">Restrict to instances that were started after the given date. By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2016-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <returns>List&lt;DurationReportResultDto&gt;</returns>
        List<DurationReportResultDto> GetHistoricProcessInstanceDurationReport(string reportType, string periodUnit, string processDefinitionIdIn = default(string), string processDefinitionKeyIn = default(string), DateTime? startedBefore = default(DateTime?), DateTime? startedAfter = default(DateTime?));
        ...
        ApiResponse<List<DurationReportResultDto>> GetHistoricProcessInstanceDurationReportWithHttpInfo(string reportType, string periodUnit, string processDefinitionIdIn = default(string), string processDefinitionKeyIn = default(string), DateTime? startedBefore = default(DateTime?), DateTime? startedAfter = default(DateTime?));
        /// <summary>
        /// Get List
        /// </summary>
        /// <remarks>
        ...
        /// <param name="processInstanceBusinessKeyIn">Filter by a list of business keys. A process instance must have one of the given business keys. Filter by a comma-separated list of &#x60;Strings&#x60; (optional)</param>
        ...
        /// <param name="startedBefore">Restrict to instances that were started before the given date. By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <param name="startedAfter">Restrict to instances that were started after the given date. By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <param name="finishedBefore">Restrict to instances that were finished before the given date. By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <param name="finishedAfter">Restrict to instances that were finished after the given date. By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <param name="executedActivityAfter">Restrict to instances that executed an activity after the given date (inclusive). By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <param name="executedActivityBefore">Restrict to instances that executed an activity before the given date (inclusive). By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <param name="executedJobAfter">Restrict to instances that executed an job after the given date (inclusive). By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <param name="executedJobBefore">Restrict to instances that executed an job before the given date (inclusive). By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
    ...
    public interface IHistoricProcessInstanceApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<List<DurationReportResultDto>>> GetHistoricProcessInstanceDurationReportWithHttpInfoAsync(string reportType, string periodUnit, string processDefinitionIdIn = default(string), string processDefinitionKeyIn = default(string), DateTime? startedBefore = default(DateTime?), DateTime? startedAfter = default(DateTime?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get List
        /// </summary>
        /// <remarks>
    ...
    public partial class HistoricProcessInstanceApi : IDisposable, IHistoricProcessInstanceApi
    {
        ...
        /// <returns></returns>
        public HistoricProcessInstanceApi(Camunda.OpenApi.Client.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public HistoricProcessInstanceApi(HttpClient client, Camunda.OpenApi.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public HistoricProcessInstanceApi(Camunda.OpenApi.Client.Client.ISynchronousClient client, Camunda.OpenApi.Client.Client.IAsynchronousClient asyncClient, Camunda.OpenApi.Client.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="failIfNotExists">If set to &#x60;false&#x60;, the request will still be successful if the process id is not found. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<Object> DeleteHistoricProcessInstanceWithHttpInfo(string id, bool? failIfNotExists = default(bool?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling HistoricProcessInstanceApi->DeleteHistoricProcessInstance");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<Object>> DeleteHistoricProcessInstanceWithHttpInfoAsync(string id, bool? failIfNotExists = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling HistoricProcessInstanceApi->DeleteHistoricProcessInstance");
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<BatchDto> localVarResponse = DeleteHistoricProcessInstancesAsyncWithHttpInfo(deleteHistoricProcessInstancesDto);
        ...
        /// <param name="deleteHistoricProcessInstancesDto"> (optional)</param>
        /// <returns>ApiResponse of BatchDto</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<BatchDto> DeleteHistoricProcessInstancesAsyncWithHttpInfo(DeleteHistoricProcessInstancesDto deleteHistoricProcessInstancesDto = default(DeleteHistoricProcessInstancesDto))
        {
            Camunda.OpenApi.Client.Client.RequestOptions localVarRequestOptions = new Camunda.OpenApi.Client.Client.RequestOptions();
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<BatchDto> localVarResponse = await DeleteHistoricProcessInstancesAsyncWithHttpInfoAsync(deleteHistoricProcessInstancesDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BatchDto)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<BatchDto>> DeleteHistoricProcessInstancesAsyncWithHttpInfoAsync(DeleteHistoricProcessInstancesDto deleteHistoricProcessInstancesDto = default(DeleteHistoricProcessInstancesDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="id">The id of the process instance for which all historic variables are to be deleted.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<Object> DeleteHistoricVariableInstancesOfHistoricProcessInstanceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling HistoricProcessInstanceApi->DeleteHistoricVariableInstancesOfHistoricProcessInstance");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<Object>> DeleteHistoricVariableInstancesOfHistoricProcessInstanceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling HistoricProcessInstanceApi->DeleteHistoricVariableInstancesOfHistoricProcessInstance");
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<HistoricProcessInstanceDto> localVarResponse = GetHistoricProcessInstanceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the historic process instance to be retrieved.</param>
        /// <returns>ApiResponse of HistoricProcessInstanceDto</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<HistoricProcessInstanceDto> GetHistoricProcessInstanceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling HistoricProcessInstanceApi->GetHistoricProcessInstance");
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<HistoricProcessInstanceDto> localVarResponse = await GetHistoricProcessInstanceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (HistoricProcessInstanceDto)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<HistoricProcessInstanceDto>> GetHistoricProcessInstanceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling HistoricProcessInstanceApi->GetHistoricProcessInstance");
        ...
        /// <param name="startedAfter">Restrict to instances that were started after the given date. By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2016-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <returns>List&lt;DurationReportResultDto&gt;</returns>
        public List<DurationReportResultDto> GetHistoricProcessInstanceDurationReport(string reportType, string periodUnit, string processDefinitionIdIn = default(string), string processDefinitionKeyIn = default(string), DateTime? startedBefore = default(DateTime?), DateTime? startedAfter = default(DateTime?))
        {
            Camunda.OpenApi.Client.Client.ApiResponse<List<DurationReportResultDto>> localVarResponse = GetHistoricProcessInstanceDurationReportWithHttpInfo(reportType, periodUnit, processDefinitionIdIn, processDefinitionKeyIn, startedBefore, startedAfter);
            return localVarResponse.Data;
        }
        ...
        /// <param name="startedAfter">Restrict to instances that were started after the given date. By [default](https://docs.camunda.org/manual/7.17/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2016-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <returns>ApiResponse of List&lt;DurationReportResultDto&gt;</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<List<DurationReportResultDto>> GetHistoricProcessInstanceDurationReportWithHttpInfo(string reportType, string periodUnit, string processDefinitionIdIn = default(string), string processDefinitionKeyIn = default(string), DateTime? startedBefore = default(DateTime?), DateTime? startedAfter = default(DateTime?))
        {
            // verify the required parameter 'reportType' is set
            if (reportType == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'reportType' when calling HistoricProcessInstanceApi->GetHistoricProcessInstanceDurationReport");

            // verify the required parameter 'periodUnit' is set
            if (periodUnit == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'periodUnit' when calling HistoricProcessInstanceApi->GetHistoricProcessInstanceDurationReport");
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<List<DurationReportResultDto>> localVarResponse = await GetHistoricProcessInstanceDurationReportWithHttpInfoAsync(reportType, periodUnit, processDefinitionIdIn, processDefinitionKeyIn, startedBefore, startedAfter, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;DurationReportResultDto&gt;)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<List<DurationReportResultDto>>> GetHistoricProcessInstanceDurationReportWithHttpInfoAsync(string reportType, string periodUnit, string processDefinitionIdIn = default(string), string processDefinitionKeyIn = default(string), DateTime? startedBefore = default(DateTime?), DateTime? startedAfter = default(DateTime?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'reportType' is set
            if (reportType == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'reportType' when calling HistoricProcessInstanceApi->GetHistoricProcessInstanceDurationReport");
        ...
        /// <summary>
        /// Get List Queries for historic process instances that fulfill the given parameters. The size of the result set can be retrieved by using the [Get Process Instance Count](https://docs.camunda.org/manual/7.17/reference/rest/history/process-instance/get-process-instance-query-count/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="sortBy">Sort the results lexicographically by a given criterion. Must be used in conjunction with the sortOrder parameter. (optional)</param>
        /// <param name="sortOrder">Sort the results in a given order. Values may be asc for ascending order or desc for descending order. Must be used in conjunction with the sortBy parameter. (optional)</param>
        ...
        /// <param name="variableValuesIgnoreCase">Match all variable values provided in variables case-insensitively. If set to &#x60;true&#x60; variableValue and variablevalue are treated as equal. (optional)</param>
        /// <returns>ApiResponse of List&lt;HistoricProcessInstanceDto&gt;</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<List<HistoricProcessInstanceDto>> GetHistoricProcessInstancesWithHttpInfo(string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?), string processInstanceId = default(string), string processInstanceIds = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string processDefinitionKeyIn = default(string), string processDefinitionName = default(string), string processDefinitionNameLike = default(string), string processDefinitionKeyNotIn = default(string), string processInstanceBusinessKey = default(string), string processInstanceBusinessKeyIn = default(string), string processInstanceBusinessKeyLike = default(string), bool? rootProcessInstances = default(bool?), bool? finished = default(bool?), bool? unfinished = default(bool?), bool? withIncidents = default(bool?), bool? withRootIncidents = default(bool?), string incidentType = default(string), string incidentStatus = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), DateTime? startedBefore = default(DateTime?), DateTime? startedAfter = default(DateTime?), DateTime? finishedBefore = default(DateTime?), DateTime? finishedAfter = default(DateTime?), DateTime? executedActivityAfter = default(DateTime?), DateTime? executedActivityBefore = default(DateTime?), DateTime? executedJobAfter = default(DateTime?), DateTime? executedJobBefore = default(DateTime?), string startedBy = default(string), string superProcessInstanceId = default(string), string subProcessInstanceId = default(string), string superCaseInstanceId = default(string), string subCaseInstanceId = default(string), string caseInstanceId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), string executedActivityIdIn = default(string), string activeActivityIdIn = default(string), bool? active = default(bool?), bool? suspended = default(bool?), bool? completed = default(bool?), bool? externallyTerminated = default(bool?), bool? internallyTerminated = default(bool?), string variables = default(string), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?))
        {
            Camunda.OpenApi.Client.Client.RequestOptions localVarRequestOptions = new Camunda.OpenApi.Client.Client.RequestOptions();
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "withIncidents", withIncidents));
            }
            if (withRootIncidents != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "withRootIncidents", withRootIncidents));
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "incidentStatus", incidentStatus));
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "executedActivityAfter", executedActivityAfter));
            }
            if (executedActivityBefore != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "executedActivityBefore", executedActivityBefore));
            }
            if (executedJobAfter != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "executedJobAfter", executedJobAfter));
            }
            if (executedJobBefore != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "executedJobBefore", executedJobBefore));
            }
            if (startedBy != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "startedBy", startedBy));
            }
            if (superProcessInstanceId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "superProcessInstanceId", superProcessInstanceId));
            }
            if (subProcessInstanceId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "subProcessInstanceId", subProcessInstanceId));
            }
            if (superCaseInstanceId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "superCaseInstanceId", superCaseInstanceId));
            }
            if (subCaseInstanceId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "subCaseInstanceId", subCaseInstanceId));
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "executedActivityIdIn", executedActivityIdIn));
            }
            if (activeActivityIdIn != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "activeActivityIdIn", activeActivityIdIn));
            }
            if (active != null)
            {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "externallyTerminated", externallyTerminated));
            }
            if (internallyTerminated != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.OpenApi.Client.Client.ClientUtils.ParameterToMultiMap("", "internallyTerminated", internallyTerminated));
            }
            if (variables != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;HistoricProcessInstanceDto&gt;)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<List<HistoricProcessInstanceDto>>> GetHistoricProcessInstancesWithHttpInfoAsync(string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?), string processInstanceId = default(string), string processInstanceIds = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string processDefinitionKeyIn = default(string), string processDefinitionName = default(string), string processDefinitionNameLike = default(string), string processDefinitionKeyNotIn = default(string), string processInstanceBusinessKey = default(string), string processInstanceBusinessKeyIn = default(string), string processInstanceBusinessKeyLike = default(string), bool? rootProcessInstances = default(bool?), bool? finished = default(bool?), bool? unfinished = default(bool?), bool? withIncidents = default(bool?), bool? withRootIncidents = default(bool?), string incidentType = default(string), string incidentStatus = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), DateTime? startedBefore = default(DateTime?), DateTime? startedAfter = default(DateTime?), DateTime? finishedBefore = default(DateTime?), DateTime? finishedAfter = default(DateTime?), DateTime? executedActivityAfter = default(DateTime?), DateTime? executedActivityBefore = default(DateTime?), DateTime? executedJobAfter = default(DateTime?), DateTime? executedJobBefore = default(DateTime?), string startedBy = default(string), string superProcessInstanceId = default(string), string subProcessInstanceId = default(string), string superCaseInstanceId = default(string), string subCaseInstanceId = default(string), string caseInstanceId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), string executedActivityIdIn = default(string), string activeActivityIdIn = default(string), bool? active = default(bool?), bool? suspended = default(bool?), bool? completed = default(bool?), bool? externallyTerminated = default(bool?), bool? internallyTerminated = default(bool?), string variables = default(string), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <summary>
        /// Get List Count Queries for the number of historic process instances that fulfill the given parameters. Takes the same parameters as the [Get Process Instances](https://docs.camunda.org/manual/7.17/reference/rest/history/process-instance/get-process-instance-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="processInstanceId">Filter by process instance id. (optional)</param>
        /// <param name="processInstanceIds">Filter by process instance ids. Filter by a comma-separated list of &#x60;Strings&#x60;. (optional)</param>
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<CountResultDto> localVarResponse = GetHistoricProcessInstancesCountWithHttpInfo(processInstanceId, processInstanceIds, processDefinitionId, processDefinitionKey, processDefinitionKeyIn, processDefinitionName, processDefinitionNameLike, processDefinitionKeyNotIn, processInstanceBusinessKey, processInstanceBusinessKeyIn, processInstanceBusinessKeyLike, rootProcessInstances, finished, unfinished, withIncidents, withRootIncidents, incidentType, incidentStatus, incidentMessage, incidentMessageLike, startedBefore, startedAfter, finishedBefore, finishedAfter, executedActivityAfter, executedActivityBefore, executedJobAfter, executedJobBefore, startedBy, superProcessInstanceId, subProcessInstanceId, superCaseInstanceId, subCaseInstanceId, caseInstanceId, tenantIdIn, withoutTenantId, executedActivityIdIn, activeActivityIdIn, active, suspended, completed, externallyTerminated, internallyTerminated, variables, variableNamesIgnoreCase, variableValuesIgnoreCase);
            return localVarResponse.Data;
        }
        ...
        /// <param name="variableValuesIgnoreCase">Match all variable values provided in variables case-insensitively. If set to &#x60;true&#x60; variableValue and variablevalue are treated as equal. (optional)</param>
        /// <returns>ApiResponse of CountResultDto</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<CountResultDto> GetHistoricProcessInstancesCountWithHttpInfo(string processInstanceId = default(string), string processInstanceIds = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string processDefinitionKeyIn = default(string), string processDefinitionName = default(string), string processDefinitionNameLike = default(string), string processDefinitionKeyNotIn = default(string), string processInstanceBusinessKey = default(string), string processInstanceBusinessKeyIn = default(string), string processInstanceBusinessKeyLike = default(string), bool? rootProcessInstances = default(bool?), bool? finished = default(bool?), bool? unfinished = default(bool?), bool? withIncidents = default(bool?), bool? withRootIncidents = default(bool?), string incidentType = default(string), string incidentStatus = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), DateTime? startedBefore = default(DateTime?), DateTime? startedAfter = default(DateTime?), DateTime? finishedBefore = default(DateTime?), DateTime? finishedAfter = default(DateTime?), DateTime? executedActivityAfter = default(DateTime?), DateTime? executedActivityBefore = default(DateTime?), DateTime? executedJobAfter = default(DateTime?), DateTime? executedJobBefore = default(DateTime?), string startedBy = default(string), string superProcessInstanceId = default(string), string subProcessInstanceId = default(string), string superCaseInstanceId = default(string), string subCaseInstanceId = default(string), string caseInstanceId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), string executedActivityIdIn = default(string), string activeActivityIdIn = default(string), bool? active = default(bool?), bool? suspended = default(bool?), bool? completed = default(bool?), bool? externallyTerminated = default(bool?), bool? internallyTerminated = default(bool?), string variables = default(string), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?))
        {
            Camunda.OpenApi.Client.Client.RequestOptions localVarRequestOptions = new Camunda.OpenApi.Client.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CountResultDto)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<CountResultDto>> GetHistoricProcessInstancesCountWithHttpInfoAsync(string processInstanceId = default(string), string processInstanceIds = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string processDefinitionKeyIn = default(string), string processDefinitionName = default(string), string processDefinitionNameLike = default(string), string processDefinitionKeyNotIn = default(string), string processInstanceBusinessKey = default(string), string processInstanceBusinessKeyIn = default(string), string processInstanceBusinessKeyLike = default(string), bool? rootProcessInstances = default(bool?), bool? finished = default(bool?), bool? unfinished = default(bool?), bool? withIncidents = default(bool?), bool? withRootIncidents = default(bool?), string incidentType = default(string), string incidentStatus = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), DateTime? startedBefore = default(DateTime?), DateTime? startedAfter = default(DateTime?), DateTime? finishedBefore = default(DateTime?), DateTime? finishedAfter = default(DateTime?), DateTime? executedActivityAfter = default(DateTime?), DateTime? executedActivityBefore = default(DateTime?), DateTime? executedJobAfter = default(DateTime?), DateTime? executedJobBefore = default(DateTime?), string startedBy = default(string), string superProcessInstanceId = default(string), string subProcessInstanceId = default(string), string superCaseInstanceId = default(string), string subCaseInstanceId = default(string), string caseInstanceId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), string executedActivityIdIn = default(string), string activeActivityIdIn = default(string), bool? active = default(bool?), bool? suspended = default(bool?), bool? completed = default(bool?), bool? externallyTerminated = default(bool?), bool? internallyTerminated = default(bool?), string variables = default(string), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<List<HistoricProcessInstanceDto>> localVarResponse = QueryHistoricProcessInstancesWithHttpInfo(firstResult, maxResults, historicProcessInstanceQueryDto);
            return localVarResponse.Data;
        }
        ...
        /// <param name="historicProcessInstanceQueryDto"> (optional)</param>
        /// <returns>ApiResponse of List&lt;HistoricProcessInstanceDto&gt;</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<List<HistoricProcessInstanceDto>> QueryHistoricProcessInstancesWithHttpInfo(int? firstResult = default(int?), int? maxResults = default(int?), HistoricProcessInstanceQueryDto historicProcessInstanceQueryDto = default(HistoricProcessInstanceQueryDto))
        {
            Camunda.OpenApi.Client.Client.RequestOptions localVarRequestOptions = new Camunda.OpenApi.Client.Client.RequestOptions();
        ...
        public async System.Threading.Tasks.Task<List<HistoricProcessInstanceDto>> QueryHistoricProcessInstancesAsync(int? firstResult = default(int?), int? maxResults = default(int?), HistoricProcessInstanceQueryDto historicProcessInstanceQueryDto = default(HistoricProcessInstanceQueryDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Camunda.OpenApi.Client.Client.ApiResponse<List<HistoricProcessInstanceDto>> localVarResponse = await QueryHistoricProcessInstancesWithHttpInfoAsync(firstResult, maxResults, historicProcessInstanceQueryDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<CountResultDto> localVarResponse = QueryHistoricProcessInstancesCountWithHttpInfo(historicProcessInstanceQueryDto);
            return localVarResponse.Data;
        }
        ...
        /// <param name="historicProcessInstanceQueryDto"> (optional)</param>
        /// <returns>ApiResponse of CountResultDto</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<CountResultDto> QueryHistoricProcessInstancesCountWithHttpInfo(HistoricProcessInstanceQueryDto historicProcessInstanceQueryDto = default(HistoricProcessInstanceQueryDto))
        {
            Camunda.OpenApi.Client.Client.RequestOptions localVarRequestOptions = new Camunda.OpenApi.Client.Client.RequestOptions();
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<CountResultDto> localVarResponse = await QueryHistoricProcessInstancesCountWithHttpInfoAsync(historicProcessInstanceQueryDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CountResultDto)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<CountResultDto>> QueryHistoricProcessInstancesCountWithHttpInfoAsync(HistoricProcessInstanceQueryDto historicProcessInstanceQueryDto = default(HistoricProcessInstanceQueryDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<BatchDto> localVarResponse = SetRemovalTimeAsyncWithHttpInfo(setRemovalTimeToHistoricProcessInstancesDto);
            return localVarResponse.Data;
        }
        ...
        /// <param name="setRemovalTimeToHistoricProcessInstancesDto"> (optional)</param>
        /// <returns>ApiResponse of BatchDto</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<BatchDto> SetRemovalTimeAsyncWithHttpInfo(SetRemovalTimeToHistoricProcessInstancesDto setRemovalTimeToHistoricProcessInstancesDto = default(SetRemovalTimeToHistoricProcessInstancesDto))
        {
            Camunda.OpenApi.Client.Client.RequestOptions localVarRequestOptions = new Camunda.OpenApi.Client.Client.RequestOptions();
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<BatchDto> localVarResponse = await SetRemovalTimeAsyncWithHttpInfoAsync(setRemovalTimeToHistoricProcessInstancesDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BatchDto)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<BatchDto>> SetRemovalTimeAsyncWithHttpInfoAsync(SetRemovalTimeToHistoricProcessInstancesDto setRemovalTimeToHistoricProcessInstancesDto = default(SetRemovalTimeToHistoricProcessInstancesDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
