...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public partial class EventSubscriptionApi : IEventSubscriptionApi
    {
        ...
        /// <summary>
        /// Get List Queries for event subscriptions that fulfill given parameters. The size of the result set can be retrieved by using the [Get Event Subscriptions count](https://docs.camunda.org/manual/7.15/reference/rest/event-subscription/get-query-count/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="eventSubscriptionId">Only select subscription with the given id. (optional)</param>
        /// <param name="eventName">Only select subscriptions for events with the given name. (optional)</param>
        ...
        /// <summary>
        /// Get List Count Queries for the number of event subscriptions that fulfill given parameters. Takes the same parameters as the [Get Event Subscriptions](https://docs.camunda.org/manual/7.15/reference/rest/event-subscription/get-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="eventSubscriptionId">Only select subscription with the given id. (optional)</param>
        /// <param name="eventName">Only select subscriptions for events with the given name. (optional)</param>
