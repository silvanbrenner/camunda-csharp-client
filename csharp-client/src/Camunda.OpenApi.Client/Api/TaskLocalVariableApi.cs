...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public interface ITaskLocalVariableApiSync : IApiAccessor
    {
        ...
        ApiResponse<FileParameter> GetTaskLocalVariableBinaryWithHttpInfo(string id, string varName);
        /// <summary>
        ...
        /// <returns></returns>
        void SetBinaryTaskLocalVariable(string id, string varName, FileParameter data = default(FileParameter), string valueType = default(string));
        ...
        /// <param name="valueType">The name of the variable type. Either Bytes for a byte array variable or File for a file variable. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> SetBinaryTaskLocalVariableWithHttpInfo(string id, string varName, FileParameter data = default(FileParameter), string valueType = default(string));
    ...
    public interface ITaskLocalVariableApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<FileParameter> GetTaskLocalVariableBinaryAsync(string id, string varName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<FileParameter>> GetTaskLocalVariableBinaryWithHttpInfoAsync(string id, string varName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get Local Task Variables
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task SetBinaryTaskLocalVariableAsync(string id, string varName, FileParameter data = default(FileParameter), string valueType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> SetBinaryTaskLocalVariableWithHttpInfoAsync(string id, string varName, FileParameter data = default(FileParameter), string valueType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TaskLocalVariableApi : IDisposable, ITaskLocalVariableApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public TaskLocalVariableApi(HttpClient client, Camunda.OpenApi.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="varName">The name of the variable to retrieve.</param>
        /// <returns>FileParameter</returns>
        public FileParameter GetTaskLocalVariableBinary(string id, string varName)
        {
            Camunda.OpenApi.Client.Client.ApiResponse<FileParameter> localVarResponse = GetTaskLocalVariableBinaryWithHttpInfo(id, varName);
            return localVarResponse.Data;
        }
        ...
        /// <param name="varName">The name of the variable to retrieve.</param>
        /// <returns>ApiResponse of FileParameter</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<FileParameter> GetTaskLocalVariableBinaryWithHttpInfo(string id, string varName)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<FileParameter>("/task/{id}/localVariables/{varName}/data", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FileParameter</returns>
        public async System.Threading.Tasks.Task<FileParameter> GetTaskLocalVariableBinaryAsync(string id, string varName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Camunda.OpenApi.Client.Client.ApiResponse<FileParameter> localVarResponse = await GetTaskLocalVariableBinaryWithHttpInfoAsync(id, varName, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FileParameter)</returns>
        public async System.Threading.Tasks.Task<Camunda.OpenApi.Client.Client.ApiResponse<FileParameter>> GetTaskLocalVariableBinaryWithHttpInfoAsync(string id, string varName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Camunda.OpenApi.Client.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->GetTaskLocalVariableBinary");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<FileParameter>("/task/{id}/localVariables/{varName}/data", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="valueType">The name of the variable type. Either Bytes for a byte array variable or File for a file variable. (optional)</param>
        /// <returns></returns>
        public void SetBinaryTaskLocalVariable(string id, string varName, FileParameter data = default(FileParameter), string valueType = default(string))
        {
        ...
        /// <param name="valueType">The name of the variable type. Either Bytes for a byte array variable or File for a file variable. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<Object> SetBinaryTaskLocalVariableWithHttpInfo(string id, string varName, FileParameter data = default(FileParameter), string valueType = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task SetBinaryTaskLocalVariableAsync(string id, string varName, FileParameter data = default(FileParameter), string valueType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
