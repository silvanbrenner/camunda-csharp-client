...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public interface ISchemaLogApiSync : IApiAccessor
    {
        ...
        List<SchemaLogEntryDto> GetSchemaLog(string version = default(string), string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?));
        ...
        ApiResponse<List<SchemaLogEntryDto>> GetSchemaLogWithHttpInfo(string version = default(string), string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?));
        /// <summary>
        /// Get List (POST)
        /// </summary>
        /// <remarks>
    ...
    public interface ISchemaLogApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<List<SchemaLogEntryDto>>> GetSchemaLogWithHttpInfoAsync(string version = default(string), string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get List (POST)
        /// </summary>
        /// <remarks>
    ...
    public partial class SchemaLogApi : IDisposable, ISchemaLogApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public SchemaLogApi(HttpClient client, Camunda.OpenApi.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="maxResults">Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)</param>
        /// <returns>List&lt;SchemaLogEntryDto&gt;</returns>
        public List<SchemaLogEntryDto> GetSchemaLog(string version = default(string), string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?))
        {
            Camunda.OpenApi.Client.Client.ApiResponse<List<SchemaLogEntryDto>> localVarResponse = GetSchemaLogWithHttpInfo(version, sortBy, sortOrder, firstResult, maxResults);
        ...
        /// <param name="maxResults">Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)</param>
        /// <returns>ApiResponse of List&lt;SchemaLogEntryDto&gt;</returns>
        public Camunda.OpenApi.Client.Client.ApiResponse<List<SchemaLogEntryDto>> GetSchemaLogWithHttpInfo(string version = default(string), string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?))
        {
        ...
        {
            Camunda.OpenApi.Client.Client.ApiResponse<List<SchemaLogEntryDto>> localVarResponse = await GetSchemaLogWithHttpInfoAsync(version, sortBy, sortOrder, firstResult, maxResults, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
