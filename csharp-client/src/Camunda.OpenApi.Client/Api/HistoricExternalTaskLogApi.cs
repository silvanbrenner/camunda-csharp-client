...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public partial class HistoricExternalTaskLogApi : IDisposable, IHistoricExternalTaskLogApi
    {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public HistoricExternalTaskLogApi(HttpClient client, Camunda.OpenApi.Client.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <summary>
        /// Get External Task Logs Queries for historic external task logs that fulfill the given parameters. The size of the result set can be retrieved by using the [Get External Task Log Count](https://docs.camunda.org/manual/7.17/reference/rest/history/external-task-log/get-external-task-log-query-count/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="logId">Filter by historic external task log id. (optional)</param>
        /// <param name="externalTaskId">Filter by external task id. (optional)</param>
        ...
        /// <summary>
        /// Get External Task Log Count Queries for the number of historic external task logs that fulfill the given parameters. Takes the same parameters as the [Get External Task Logs](https://docs.camunda.org/manual/7.17/reference/rest/history/external-task-log/get-external-task-log-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="logId">Filter by historic external task log id. (optional)</param>
        /// <param name="externalTaskId">Filter by external task id. (optional)</param>
