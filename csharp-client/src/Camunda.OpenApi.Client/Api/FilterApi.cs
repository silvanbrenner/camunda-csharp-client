...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public partial class FilterApi : IDisposable, IFilterApi
    {
        ...
        /// <summary>
        /// Get Filter Count Retrieves the number of filters that fulfill a provided query. Corresponds to the size of the result set when using the  [Get Filters](https://docs.camunda.org/manual/7.16/reference/rest/filter/get-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="filterId">Filter by the id of the filter. (optional)</param>
        /// <param name="resourceType">Filter by the resource type of the filter, e.g., &#x60;Task&#x60;. (optional)</param>
        ...
        /// <summary>
        /// Get Filters Queries for a list of filters using a list of parameters. The size of the result set can be retrieved by using the [Get Filter Count](https://docs.camunda.org/manual/7.16/reference/rest/filter/get-query-count/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="filterId">Filter by the id of the filter. (optional)</param>
        /// <param name="resourceType">Filter by the resource type of the filter, e.g., &#x60;Task&#x60;. (optional)</param>
