...
namespace Camunda.OpenApi.Client.Api
{
    ...
    public interface IHistoricJobLogApiSync : IApiAccessor
    {
        ...
        /// <param name="jobDefinitionType">Filter by job definition type. See the [User Guide](https://docs.camunda.org/manual/7.16/user-guide/process-engine/the-job-executor/#job-creation) for more information about job definition types. (optional)</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class HistoricJobLogApi : IHistoricJobLogApi
    {
        ...
        /// <summary>
        /// Get Job Logs Queries for historic job logs that fulfill the given parameters. The size of the result set can be retrieved by using the [Get Job Log Count](https://docs.camunda.org/manual/7.16/reference/rest/history/job-log/get-job-log-query-count/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="logId">Filter by historic job log id. (optional)</param>
        /// <param name="jobId">Filter by job id. (optional)</param>
        ...
        /// <summary>
        /// Get Job Log Count Queries for the number of historic job logs that fulfill the given parameters. Takes the same parameters as the [Get Job Logs](https://docs.camunda.org/manual/7.16/reference/rest/history/job-log/get-job-log-query/) method.
        /// </summary>
        /// <exception cref="Camunda.OpenApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="logId">Filter by historic job log id. (optional)</param>
        /// <param name="jobId">Filter by job id. (optional)</param>
