...
namespace CamundaClient.Model
{
    ...
    public partial class AbstractSetRemovalTimeDto : IEquatable<AbstractSetRemovalTimeDto>, IValidatableObject
    {
        ...
        public AbstractSetRemovalTimeDto(DateTime? absoluteRemovalTime = default(DateTime?), bool? clearedRemovalTime = default(bool?), bool? calculatedRemovalTime = default(bool?))
        {
