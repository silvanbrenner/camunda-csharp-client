...
namespace CamundaClient.Api
{
    ...
    public partial class VersionApi : IVersionApi
    {
        ...
        /// <returns></returns>
        public VersionApi(CamundaClient.Client.Configuration configuration)
        {
        ...
        public VersionApi(CamundaClient.Client.ISynchronousClient client, CamundaClient.Client.IAsynchronousClient asyncClient, CamundaClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            CamundaClient.Client.ApiResponse<VersionDto> localVarResponse = GetRestAPIVersionWithHttpInfo();
        ...
        /// <exception cref="CamundaClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of VersionDto</returns>
        public CamundaClient.Client.ApiResponse<VersionDto> GetRestAPIVersionWithHttpInfo()
        {
        ...
        {
            CamundaClient.Client.ApiResponse<VersionDto> localVarResponse = await GetRestAPIVersionWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VersionDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<VersionDto>> GetRestAPIVersionWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
