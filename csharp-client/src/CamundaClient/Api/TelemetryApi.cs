...
namespace CamundaClient.Api
{
    ...
    public partial class TelemetryApi : ITelemetryApi
    {
        ...
        /// <returns></returns>
        public TelemetryApi(CamundaClient.Client.Configuration configuration)
        {
        ...
        public TelemetryApi(CamundaClient.Client.ISynchronousClient client, CamundaClient.Client.IAsynchronousClient asyncClient, CamundaClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="telemetryConfigurationDto"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> ConfigureTelemetryWithHttpInfo(TelemetryConfigurationDto telemetryConfigurationDto = default(TelemetryConfigurationDto))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> ConfigureTelemetryWithHttpInfoAsync(TelemetryConfigurationDto telemetryConfigurationDto = default(TelemetryConfigurationDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            CamundaClient.Client.ApiResponse<TelemetryConfigurationDto> localVarResponse = GetTelemetryConfigurationWithHttpInfo();
        ...
        /// <exception cref="CamundaClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of TelemetryConfigurationDto</returns>
        public CamundaClient.Client.ApiResponse<TelemetryConfigurationDto> GetTelemetryConfigurationWithHttpInfo()
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
        ...
        {
            CamundaClient.Client.ApiResponse<TelemetryConfigurationDto> localVarResponse = await GetTelemetryConfigurationWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TelemetryConfigurationDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<TelemetryConfigurationDto>> GetTelemetryConfigurationWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
