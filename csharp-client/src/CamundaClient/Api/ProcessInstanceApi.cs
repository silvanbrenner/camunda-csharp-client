...
namespace CamundaClient.Api
{
    ...
    public interface IProcessInstanceApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Dictionary<string, VariableValueDto>> GetProcessInstanceVariablesAsync(string id, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Dictionary<string, VariableValueDto>>> GetProcessInstanceVariablesWithHttpInfoAsync(string id, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class ProcessInstanceApi : IProcessInstanceApi
    {
        ...
        /// <returns></returns>
        public ProcessInstanceApi(CamundaClient.Client.Configuration configuration)
        {
        ...
        public ProcessInstanceApi(CamundaClient.Client.ISynchronousClient client, CamundaClient.Client.IAsynchronousClient asyncClient, CamundaClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = DeleteAsyncHistoricQueryBasedWithHttpInfo(deleteProcessInstancesDto);
        ...
        /// <param name="deleteProcessInstancesDto">**Unallowed property**: &#x60;processInstanceQuery&#x60; (optional)</param>
        /// <returns>ApiResponse of BatchDto</returns>
        public CamundaClient.Client.ApiResponse<BatchDto> DeleteAsyncHistoricQueryBasedWithHttpInfo(DeleteProcessInstancesDto deleteProcessInstancesDto = default(DeleteProcessInstancesDto))
        {
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = await DeleteAsyncHistoricQueryBasedWithHttpInfoAsync(deleteProcessInstancesDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="failIfNotExists">If set to false, the request will still be successful if the process id is not found. (optional, default to true)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> DeleteProcessInstanceWithHttpInfo(string id, bool? skipCustomListeners = default(bool?), bool? skipIoMappings = default(bool?), bool? skipSubprocesses = default(bool?), bool? failIfNotExists = default(bool?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->DeleteProcessInstance");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "skipSubprocesses", skipSubprocesses));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> DeleteProcessInstanceWithHttpInfoAsync(string id, bool? skipCustomListeners = default(bool?), bool? skipIoMappings = default(bool?), bool? skipSubprocesses = default(bool?), bool? failIfNotExists = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->DeleteProcessInstance");
        ...
        /// <param name="varName">The name of the variable to delete.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> DeleteProcessInstanceVariableWithHttpInfo(string id, string varName)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->DeleteProcessInstanceVariable");

            // verify the required parameter 'varName' is set
            if (varName == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'varName' when calling ProcessInstanceApi->DeleteProcessInstanceVariable");
            ...
            localVarRequestOptions.PathParameters.Add("id", CamundaClient.Client.ClientUtils.ParameterToString(id)); // path parameter
            localVarRequestOptions.PathParameters.Add("varName", CamundaClient.Client.ClientUtils.ParameterToString(varName)); // path parameter
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> DeleteProcessInstanceVariableWithHttpInfoAsync(string id, string varName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->DeleteProcessInstanceVariable");
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = DeleteProcessInstancesAsyncOperationWithHttpInfo(deleteProcessInstancesDto);
            return localVarResponse.Data;
        }
        ...
        /// <param name="deleteProcessInstancesDto">**Unallowed property**: &#x60;historicProcessInstanceQuery&#x60; (optional)</param>
        /// <returns>ApiResponse of BatchDto</returns>
        public CamundaClient.Client.ApiResponse<BatchDto> DeleteProcessInstancesAsyncOperationWithHttpInfo(DeleteProcessInstancesDto deleteProcessInstancesDto = default(DeleteProcessInstancesDto))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = await DeleteProcessInstancesAsyncOperationWithHttpInfoAsync(deleteProcessInstancesDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            CamundaClient.Client.ApiResponse<ActivityInstanceDto> localVarResponse = GetActivityInstanceTreeWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the process instance for which the activity instance should be retrieved.</param>
        /// <returns>ApiResponse of ActivityInstanceDto</returns>
        public CamundaClient.Client.ApiResponse<ActivityInstanceDto> GetActivityInstanceTreeWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->GetActivityInstanceTree");
        ...
        {
            CamundaClient.Client.ApiResponse<ActivityInstanceDto> localVarResponse = await GetActivityInstanceTreeWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ActivityInstanceDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<ActivityInstanceDto>> GetActivityInstanceTreeWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->GetActivityInstanceTree");
        ...
        {
            CamundaClient.Client.ApiResponse<ProcessInstanceDto> localVarResponse = GetProcessInstanceWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id">The id of the process instance to be retrieved.</param>
        /// <returns>ApiResponse of ProcessInstanceDto</returns>
        public CamundaClient.Client.ApiResponse<ProcessInstanceDto> GetProcessInstanceWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->GetProcessInstance");
        ...
        {
            CamundaClient.Client.ApiResponse<ProcessInstanceDto> localVarResponse = await GetProcessInstanceWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ProcessInstanceDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<ProcessInstanceDto>> GetProcessInstanceWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->GetProcessInstance");
        ...
        {
            CamundaClient.Client.ApiResponse<VariableValueDto> localVarResponse = GetProcessInstanceVariableWithHttpInfo(id, varName, deserializeValue);
            return localVarResponse.Data;
        }
        ...
        /// <param name="deserializeValue">Determines whether serializable variable values (typically variables that store custom Java objects) should be deserialized on server side (default true).  If set to true, a serializable variable will be deserialized on server side and transformed to JSON using [Jackson&#39;s](https://github.com/FasterXML/jackson) POJO/bean property introspection feature. Note that this requires the Java classes of the variable value to be on the REST API&#39;s classpath.  If set to false, a serializable variable will be returned in its serialized format. For example, a variable that is serialized as XML will be returned as a JSON string containing XML.  Note: While true is the default value for reasons of backward compatibility, we recommend setting this parameter to false when developing web applications that are independent of the Java process applications deployed to the engine. (optional, default to true)</param>
        /// <returns>ApiResponse of VariableValueDto</returns>
        public CamundaClient.Client.ApiResponse<VariableValueDto> GetProcessInstanceVariableWithHttpInfo(string id, string varName, bool? deserializeValue = default(bool?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->GetProcessInstanceVariable");

            // verify the required parameter 'varName' is set
            if (varName == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'varName' when calling ProcessInstanceApi->GetProcessInstanceVariable");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "deserializeValue", deserializeValue));
            }
        ...
        {
            CamundaClient.Client.ApiResponse<VariableValueDto> localVarResponse = await GetProcessInstanceVariableWithHttpInfoAsync(id, varName, deserializeValue, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VariableValueDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<VariableValueDto>> GetProcessInstanceVariableWithHttpInfoAsync(string id, string varName, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->GetProcessInstanceVariable");
        ...
        {
            CamundaClient.Client.ApiResponse<System.IO.Stream> localVarResponse = GetProcessInstanceVariableBinaryWithHttpInfo(id, varName);
            return localVarResponse.Data;
        }
        ...
        /// <param name="varName">The name of the variable to retrieve.</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public CamundaClient.Client.ApiResponse<System.IO.Stream> GetProcessInstanceVariableBinaryWithHttpInfo(string id, string varName)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->GetProcessInstanceVariableBinary");

            // verify the required parameter 'varName' is set
            if (varName == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'varName' when calling ProcessInstanceApi->GetProcessInstanceVariableBinary");
        ...
        {
            CamundaClient.Client.ApiResponse<System.IO.Stream> localVarResponse = await GetProcessInstanceVariableBinaryWithHttpInfoAsync(id, varName, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<System.IO.Stream>> GetProcessInstanceVariableBinaryWithHttpInfoAsync(string id, string varName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->GetProcessInstanceVariableBinary");
        ...
        {
            CamundaClient.Client.ApiResponse<Dictionary<string, VariableValueDto>> localVarResponse = GetProcessInstanceVariablesWithHttpInfo(id, deserializeValue);
            return localVarResponse.Data;
        }
        ...
        /// <param name="deserializeValue">Determines whether serializable variable values (typically variables that store custom Java objects) should be deserialized on server side (default true).  If set to true, a serializable variable will be deserialized on server side and transformed to JSON using [Jackson&#39;s](https://github.com/FasterXML/jackson) POJO/bean property introspection feature. Note that this requires the Java classes of the variable value to be on the REST API&#39;s classpath.  If set to false, a serializable variable will be returned in its serialized format. For example, a variable that is serialized as XML will be returned as a JSON string containing XML.  Note: While true is the default value for reasons of backward compatibility, we recommend setting this parameter to false when developing web applications that are independent of the Java process applications deployed to the engine. (optional, default to true)</param>
        /// <returns>ApiResponse of Dictionary&lt;string, VariableValueDto&gt;</returns>
        public CamundaClient.Client.ApiResponse<Dictionary<string, VariableValueDto>> GetProcessInstanceVariablesWithHttpInfo(string id, bool? deserializeValue = default(bool?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->GetProcessInstanceVariables");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Dictionary&lt;string, VariableValueDto&gt;</returns>
        public async System.Threading.Tasks.Task<Dictionary<string, VariableValueDto>> GetProcessInstanceVariablesAsync(string id, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            CamundaClient.Client.ApiResponse<Dictionary<string, VariableValueDto>> localVarResponse = await GetProcessInstanceVariablesWithHttpInfoAsync(id, deserializeValue, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, VariableValueDto&gt;)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Dictionary<string, VariableValueDto>>> GetProcessInstanceVariablesWithHttpInfoAsync(string id, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->GetProcessInstanceVariables");
        ...
        /// <param name="variableValuesIgnoreCase">Match all variable values in this query case-insensitively. If set to true variableValue and variablevalue are treated as equal. (optional, default to false)</param>
        /// <returns>ApiResponse of List&lt;ProcessInstanceDto&gt;</returns>
        public CamundaClient.Client.ApiResponse<List<ProcessInstanceDto>> GetProcessInstancesWithHttpInfo(string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?), string processInstanceIds = default(string), string businessKey = default(string), string businessKeyLike = default(string), string caseInstanceId = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string processDefinitionKeyIn = default(string), string processDefinitionKeyNotIn = default(string), string deploymentId = default(string), string superProcessInstance = default(string), string subProcessInstance = default(string), string superCaseInstance = default(string), string subCaseInstance = default(string), bool? active = default(bool?), bool? suspended = default(bool?), bool? withIncident = default(bool?), string incidentId = default(string), string incidentType = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? processDefinitionWithoutTenantId = default(bool?), string activityIdIn = default(string), bool? rootProcessInstances = default(bool?), bool? leafProcessInstances = default(bool?), string variables = default(string), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
            ...
            if (businessKey != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "businessKey", businessKey));
            }
            if (businessKeyLike != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "businessKeyLike", businessKeyLike));
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "superProcessInstance", superProcessInstance));
            }
            if (subProcessInstance != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "subProcessInstance", subProcessInstance));
            }
            if (superCaseInstance != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "superCaseInstance", superCaseInstance));
            }
            if (subCaseInstance != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "subCaseInstance", subCaseInstance));
            }
            if (active != null)
            {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "withIncident", withIncident));
            }
            if (incidentId != null)
            {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "processDefinitionWithoutTenantId", processDefinitionWithoutTenantId));
            }
            if (activityIdIn != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "activityIdIn", activityIdIn));
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "leafProcessInstances", leafProcessInstances));
            }
            if (variables != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ProcessInstanceDto&gt;)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<List<ProcessInstanceDto>>> GetProcessInstancesWithHttpInfoAsync(string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?), string processInstanceIds = default(string), string businessKey = default(string), string businessKeyLike = default(string), string caseInstanceId = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string processDefinitionKeyIn = default(string), string processDefinitionKeyNotIn = default(string), string deploymentId = default(string), string superProcessInstance = default(string), string subProcessInstance = default(string), string superCaseInstance = default(string), string subCaseInstance = default(string), bool? active = default(bool?), bool? suspended = default(bool?), bool? withIncident = default(bool?), string incidentId = default(string), string incidentType = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? processDefinitionWithoutTenantId = default(bool?), string activityIdIn = default(string), bool? rootProcessInstances = default(bool?), bool? leafProcessInstances = default(bool?), string variables = default(string), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="variableValuesIgnoreCase">Match all variable values in this query case-insensitively. If set to true variableValue and variablevalue are treated as equal. (optional, default to false)</param>
        /// <returns>ApiResponse of CountResultDto</returns>
        public CamundaClient.Client.ApiResponse<CountResultDto> GetProcessInstancesCountWithHttpInfo(string processInstanceIds = default(string), string businessKey = default(string), string businessKeyLike = default(string), string caseInstanceId = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string processDefinitionKeyIn = default(string), string processDefinitionKeyNotIn = default(string), string deploymentId = default(string), string superProcessInstance = default(string), string subProcessInstance = default(string), string superCaseInstance = default(string), string subCaseInstance = default(string), bool? active = default(bool?), bool? suspended = default(bool?), bool? withIncident = default(bool?), string incidentId = default(string), string incidentType = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? processDefinitionWithoutTenantId = default(bool?), string activityIdIn = default(string), bool? rootProcessInstances = default(bool?), bool? leafProcessInstances = default(bool?), string variables = default(string), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CountResultDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<CountResultDto>> GetProcessInstancesCountWithHttpInfoAsync(string processInstanceIds = default(string), string businessKey = default(string), string businessKeyLike = default(string), string caseInstanceId = default(string), string processDefinitionId = default(string), string processDefinitionKey = default(string), string processDefinitionKeyIn = default(string), string processDefinitionKeyNotIn = default(string), string deploymentId = default(string), string superProcessInstance = default(string), string subProcessInstance = default(string), string superCaseInstance = default(string), string subCaseInstance = default(string), bool? active = default(bool?), bool? suspended = default(bool?), bool? withIncident = default(bool?), string incidentId = default(string), string incidentType = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? processDefinitionWithoutTenantId = default(bool?), string activityIdIn = default(string), bool? rootProcessInstances = default(bool?), bool? leafProcessInstances = default(bool?), string variables = default(string), bool? variableNamesIgnoreCase = default(bool?), bool? variableValuesIgnoreCase = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="processInstanceModificationDto"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> ModifyProcessInstanceWithHttpInfo(string id, ProcessInstanceModificationDto processInstanceModificationDto = default(ProcessInstanceModificationDto))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->ModifyProcessInstance");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> ModifyProcessInstanceWithHttpInfoAsync(string id, ProcessInstanceModificationDto processInstanceModificationDto = default(ProcessInstanceModificationDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->ModifyProcessInstance");
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = ModifyProcessInstanceAsyncOperationWithHttpInfo(id, processInstanceModificationDto);
            return localVarResponse.Data;
        }
        ...
        /// <param name="processInstanceModificationDto"> (optional)</param>
        /// <returns>ApiResponse of BatchDto</returns>
        public CamundaClient.Client.ApiResponse<BatchDto> ModifyProcessInstanceAsyncOperationWithHttpInfo(string id, ProcessInstanceModificationDto processInstanceModificationDto = default(ProcessInstanceModificationDto))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->ModifyProcessInstanceAsyncOperation");
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = await ModifyProcessInstanceAsyncOperationWithHttpInfoAsync(id, processInstanceModificationDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BatchDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<BatchDto>> ModifyProcessInstanceAsyncOperationWithHttpInfoAsync(string id, ProcessInstanceModificationDto processInstanceModificationDto = default(ProcessInstanceModificationDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->ModifyProcessInstanceAsyncOperation");
        ...
        /// <param name="patchVariablesDto"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> ModifyProcessInstanceVariablesWithHttpInfo(string id, PatchVariablesDto patchVariablesDto = default(PatchVariablesDto))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->ModifyProcessInstanceVariables");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> ModifyProcessInstanceVariablesWithHttpInfoAsync(string id, PatchVariablesDto patchVariablesDto = default(PatchVariablesDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->ModifyProcessInstanceVariables");
        ...
        {
            CamundaClient.Client.ApiResponse<List<ProcessInstanceDto>> localVarResponse = QueryProcessInstancesWithHttpInfo(firstResult, maxResults, processInstanceQueryDto);
            return localVarResponse.Data;
        }
        ...
        /// <param name="processInstanceQueryDto"> (optional)</param>
        /// <returns>ApiResponse of List&lt;ProcessInstanceDto&gt;</returns>
        public CamundaClient.Client.ApiResponse<List<ProcessInstanceDto>> QueryProcessInstancesWithHttpInfo(int? firstResult = default(int?), int? maxResults = default(int?), ProcessInstanceQueryDto processInstanceQueryDto = default(ProcessInstanceQueryDto))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
        ...
        public async System.Threading.Tasks.Task<List<ProcessInstanceDto>> QueryProcessInstancesAsync(int? firstResult = default(int?), int? maxResults = default(int?), ProcessInstanceQueryDto processInstanceQueryDto = default(ProcessInstanceQueryDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            CamundaClient.Client.ApiResponse<List<ProcessInstanceDto>> localVarResponse = await QueryProcessInstancesWithHttpInfoAsync(firstResult, maxResults, processInstanceQueryDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ProcessInstanceDto&gt;)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<List<ProcessInstanceDto>>> QueryProcessInstancesWithHttpInfoAsync(int? firstResult = default(int?), int? maxResults = default(int?), ProcessInstanceQueryDto processInstanceQueryDto = default(ProcessInstanceQueryDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            CamundaClient.Client.ApiResponse<CountResultDto> localVarResponse = QueryProcessInstancesCountWithHttpInfo(processInstanceQueryDto);
            return localVarResponse.Data;
        }
        ...
        /// <param name="processInstanceQueryDto"> (optional)</param>
        /// <returns>ApiResponse of CountResultDto</returns>
        public CamundaClient.Client.ApiResponse<CountResultDto> QueryProcessInstancesCountWithHttpInfo(ProcessInstanceQueryDto processInstanceQueryDto = default(ProcessInstanceQueryDto))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
        ...
        {
            CamundaClient.Client.ApiResponse<CountResultDto> localVarResponse = await QueryProcessInstancesCountWithHttpInfoAsync(processInstanceQueryDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CountResultDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<CountResultDto>> QueryProcessInstancesCountWithHttpInfoAsync(ProcessInstanceQueryDto processInstanceQueryDto = default(ProcessInstanceQueryDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="variableValueDto"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> SetProcessInstanceVariableWithHttpInfo(string id, string varName, VariableValueDto variableValueDto = default(VariableValueDto))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->SetProcessInstanceVariable");

            // verify the required parameter 'varName' is set
            if (varName == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'varName' when calling ProcessInstanceApi->SetProcessInstanceVariable");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> SetProcessInstanceVariableWithHttpInfoAsync(string id, string varName, VariableValueDto variableValueDto = default(VariableValueDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->SetProcessInstanceVariable");
        ...
        /// <param name="valueType">The name of the variable type. Either Bytes for a byte array variable or File for a file variable. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> SetProcessInstanceVariableBinaryWithHttpInfo(string id, string varName, System.IO.Stream data = default(System.IO.Stream), string valueType = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->SetProcessInstanceVariableBinary");

            // verify the required parameter 'varName' is set
            if (varName == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'varName' when calling ProcessInstanceApi->SetProcessInstanceVariableBinary");
            ...
            if (valueType != null)
            {
                localVarRequestOptions.FormParameters.Add("valueType", CamundaClient.Client.ClientUtils.ParameterToString(valueType)); // form parameter
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> SetProcessInstanceVariableBinaryWithHttpInfoAsync(string id, string varName, System.IO.Stream data = default(System.IO.Stream), string valueType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->SetProcessInstanceVariableBinary");
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = SetRetriesByProcessWithHttpInfo(setJobRetriesByProcessDto);
            return localVarResponse.Data;
        }
        ...
        /// <param name="setJobRetriesByProcessDto">Please note that if both processInstances and processInstanceQuery are provided, then the resulting execution will be performed on the union of these sets. **Unallowed property**: &#x60;historicProcessInstanceQuery&#x60; (optional)</param>
        /// <returns>ApiResponse of BatchDto</returns>
        public CamundaClient.Client.ApiResponse<BatchDto> SetRetriesByProcessWithHttpInfo(SetJobRetriesByProcessDto setJobRetriesByProcessDto = default(SetJobRetriesByProcessDto))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = await SetRetriesByProcessWithHttpInfoAsync(setJobRetriesByProcessDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BatchDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<BatchDto>> SetRetriesByProcessWithHttpInfoAsync(SetJobRetriesByProcessDto setJobRetriesByProcessDto = default(SetJobRetriesByProcessDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = SetRetriesByProcessHistoricQueryBasedWithHttpInfo(setJobRetriesByProcessDto);
            return localVarResponse.Data;
        }
        ...
        /// <param name="setJobRetriesByProcessDto">Please note that if both processInstances and historicProcessInstanceQuery are provided, then the resulting execution will be performed on the union of these sets. **Unallowed property**: &#x60;processInstanceQuery&#x60; (optional)</param>
        /// <returns>ApiResponse of BatchDto</returns>
        public CamundaClient.Client.ApiResponse<BatchDto> SetRetriesByProcessHistoricQueryBasedWithHttpInfo(SetJobRetriesByProcessDto setJobRetriesByProcessDto = default(SetJobRetriesByProcessDto))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = await SetRetriesByProcessHistoricQueryBasedWithHttpInfoAsync(setJobRetriesByProcessDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BatchDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<BatchDto>> SetRetriesByProcessHistoricQueryBasedWithHttpInfoAsync(SetJobRetriesByProcessDto setJobRetriesByProcessDto = default(SetJobRetriesByProcessDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = SetVariablesAsyncOperationWithHttpInfo(setVariablesAsyncDto);
            return localVarResponse.Data;
        }
        ...
        /// <param name="setVariablesAsyncDto"> (optional)</param>
        /// <returns>ApiResponse of BatchDto</returns>
        public CamundaClient.Client.ApiResponse<BatchDto> SetVariablesAsyncOperationWithHttpInfo(SetVariablesAsyncDto setVariablesAsyncDto = default(SetVariablesAsyncDto))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = await SetVariablesAsyncOperationWithHttpInfoAsync(setVariablesAsyncDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BatchDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<BatchDto>> SetVariablesAsyncOperationWithHttpInfoAsync(SetVariablesAsyncDto setVariablesAsyncDto = default(SetVariablesAsyncDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="processInstanceSuspensionStateDto"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> UpdateSuspensionStateWithHttpInfo(ProcessInstanceSuspensionStateDto processInstanceSuspensionStateDto = default(ProcessInstanceSuspensionStateDto))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> UpdateSuspensionStateWithHttpInfoAsync(ProcessInstanceSuspensionStateDto processInstanceSuspensionStateDto = default(ProcessInstanceSuspensionStateDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = UpdateSuspensionStateAsyncOperationWithHttpInfo(processInstanceSuspensionStateAsyncDto);
            return localVarResponse.Data;
        }
        ...
        /// <param name="processInstanceSuspensionStateAsyncDto"> (optional)</param>
        /// <returns>ApiResponse of BatchDto</returns>
        public CamundaClient.Client.ApiResponse<BatchDto> UpdateSuspensionStateAsyncOperationWithHttpInfo(ProcessInstanceSuspensionStateAsyncDto processInstanceSuspensionStateAsyncDto = default(ProcessInstanceSuspensionStateAsyncDto))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
        ...
        {
            CamundaClient.Client.ApiResponse<BatchDto> localVarResponse = await UpdateSuspensionStateAsyncOperationWithHttpInfoAsync(processInstanceSuspensionStateAsyncDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BatchDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<BatchDto>> UpdateSuspensionStateAsyncOperationWithHttpInfoAsync(ProcessInstanceSuspensionStateAsyncDto processInstanceSuspensionStateAsyncDto = default(ProcessInstanceSuspensionStateAsyncDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="suspensionStateDto"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> UpdateSuspensionStateByIdWithHttpInfo(string id, SuspensionStateDto suspensionStateDto = default(SuspensionStateDto))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->UpdateSuspensionStateById");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> UpdateSuspensionStateByIdWithHttpInfoAsync(string id, SuspensionStateDto suspensionStateDto = default(SuspensionStateDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling ProcessInstanceApi->UpdateSuspensionStateById");
