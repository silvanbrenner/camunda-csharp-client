...
namespace CamundaClient.Api
{
    ...
    public partial class MetricsApi : IMetricsApi
    {
        ...
        /// <returns></returns>
        public MetricsApi(CamundaClient.Client.Configuration configuration)
        {
        ...
        public MetricsApi(CamundaClient.Client.ISynchronousClient client, CamundaClient.Client.IAsynchronousClient asyncClient, CamundaClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            CamundaClient.Client.ApiResponse<MetricsResultDto> localVarResponse = GetMetricsWithHttpInfo(metricsName, startDate, endDate);
        ...
        /// <param name="endDate">The end date (exclusive). (optional)</param>
        /// <returns>ApiResponse of MetricsResultDto</returns>
        public CamundaClient.Client.ApiResponse<MetricsResultDto> GetMetricsWithHttpInfo(string metricsName, DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?))
        {
            // verify the required parameter 'metricsName' is set
            if (metricsName == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'metricsName' when calling MetricsApi->GetMetrics");
            ...
            localVarRequestOptions.PathParameters.Add("metrics-name", CamundaClient.Client.ClientUtils.ParameterToString(metricsName)); // path parameter
            if (startDate != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "startDate", startDate));
            }
            if (endDate != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "endDate", endDate));
            }
        ...
        {
            CamundaClient.Client.ApiResponse<MetricsResultDto> localVarResponse = await GetMetricsWithHttpInfoAsync(metricsName, startDate, endDate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            CamundaClient.Client.ApiResponse<List<MetricsIntervalResultDto>> localVarResponse = IntervalWithHttpInfo(name, reporter, startDate, endDate, firstResult, maxResults, interval, aggregateByReporter);
            return localVarResponse.Data;
        }
        ...
        /// <param name="aggregateByReporter">Aggregate metrics by reporter. (optional)</param>
        /// <returns>ApiResponse of List&lt;MetricsIntervalResultDto&gt;</returns>
        public CamundaClient.Client.ApiResponse<List<MetricsIntervalResultDto>> IntervalWithHttpInfo(string name = default(string), string reporter = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), int? firstResult = default(int?), int? maxResults = default(int?), string interval = default(string), string aggregateByReporter = default(string))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
            ...
            if (reporter != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "reporter", reporter));
            }
            if (startDate != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "startDate", startDate));
            ...
            if (interval != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "interval", interval));
            }
            if (aggregateByReporter != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "aggregateByReporter", aggregateByReporter));
            }
        ...
        {
            CamundaClient.Client.ApiResponse<List<MetricsIntervalResultDto>> localVarResponse = await IntervalWithHttpInfoAsync(name, reporter, startDate, endDate, firstResult, maxResults, interval, aggregateByReporter, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;MetricsIntervalResultDto&gt;)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<List<MetricsIntervalResultDto>>> IntervalWithHttpInfoAsync(string name = default(string), string reporter = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), int? firstResult = default(int?), int? maxResults = default(int?), string interval = default(string), string aggregateByReporter = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
