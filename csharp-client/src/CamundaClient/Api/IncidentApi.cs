...
namespace CamundaClient.Api
{
    ...
    public interface IIncidentApiSync : IApiAccessor
    {
        ...
        /// <param name="incidentType">Restricts to incidents that belong to the given incident type. See the [User Guide](https://docs.camunda.org/manual/7.14/user-guide/process-engine/incidents/#incident-types) for a list of incident types. (optional)</param>
        ...
        /// <param name="incidentTimestampBefore">Restricts to incidents that have an incidentTimestamp date before the given date. By default, the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
        /// <param name="incidentTimestampAfter">Restricts to incidents that have an incidentTimestamp date after the given date. By default*, the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)</param>
    ...
    public partial class IncidentApi : IIncidentApi
    {
        ...
        /// <returns></returns>
        public IncidentApi(CamundaClient.Client.Configuration configuration)
        {
        ...
        public IncidentApi(CamundaClient.Client.ISynchronousClient client, CamundaClient.Client.IAsynchronousClient asyncClient, CamundaClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            CamundaClient.Client.ApiResponse<IncidentDto> localVarResponse = GetIncidentWithHttpInfo(id);
        ...
        /// <param name="id">The id of the incident to be retrieved.</param>
        /// <returns>ApiResponse of IncidentDto</returns>
        public CamundaClient.Client.ApiResponse<IncidentDto> GetIncidentWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling IncidentApi->GetIncident");
        ...
        {
            CamundaClient.Client.ApiResponse<IncidentDto> localVarResponse = await GetIncidentWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (IncidentDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<IncidentDto>> GetIncidentWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling IncidentApi->GetIncident");
        ...
        /// <summary>
        /// Get List Queries for incidents that fulfill given parameters. The size of the result set can be retrieved by using the [Get Incident Count](https://docs.camunda.org/manual/7.14/reference/rest/incident/get-query-count/) method.
        /// </summary>
        /// <exception cref="CamundaClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="incidentId">Restricts to incidents that have the given id. (optional)</param>
        /// <param name="incidentType">Restricts to incidents that belong to the given incident type. See the [User Guide](https://docs.camunda.org/manual/7.14/user-guide/process-engine/incidents/#incident-types) for a list of incident types. (optional)</param>
        ...
        /// <param name="sortOrder">Sort the results in a given order. Values may be asc for ascending order or desc for descending order. Must be used in conjunction with the sortBy parameter. (optional)</param>
        /// <returns>ApiResponse of List&lt;IncidentDto&gt;</returns>
        public CamundaClient.Client.ApiResponse<List<IncidentDto>> GetIncidentsWithHttpInfo(string incidentId = default(string), string incidentType = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), string processDefinitionId = default(string), string processDefinitionKeyIn = default(string), string processInstanceId = default(string), string executionId = default(string), DateTime? incidentTimestampBefore = default(DateTime?), DateTime? incidentTimestampAfter = default(DateTime?), string activityId = default(string), string failedActivityId = default(string), string causeIncidentId = default(string), string rootCauseIncidentId = default(string), string configuration = default(string), string tenantIdIn = default(string), string jobDefinitionIdIn = default(string), string sortBy = default(string), string sortOrder = default(string))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
            ...
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "incidentTimestampBefore", incidentTimestampBefore));
            }
            if (incidentTimestampAfter != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "incidentTimestampAfter", incidentTimestampAfter));
            }
            if (activityId != null)
            {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "failedActivityId", failedActivityId));
            }
            if (causeIncidentId != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "causeIncidentId", causeIncidentId));
            }
            if (rootCauseIncidentId != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "rootCauseIncidentId", rootCauseIncidentId));
            }
            if (configuration != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "configuration", configuration));
            }
            if (tenantIdIn != null)
            {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "jobDefinitionIdIn", jobDefinitionIdIn));
            }
            if (sortBy != null)
            {
        ...
        {
            CamundaClient.Client.ApiResponse<List<IncidentDto>> localVarResponse = await GetIncidentsWithHttpInfoAsync(incidentId, incidentType, incidentMessage, incidentMessageLike, processDefinitionId, processDefinitionKeyIn, processInstanceId, executionId, incidentTimestampBefore, incidentTimestampAfter, activityId, failedActivityId, causeIncidentId, rootCauseIncidentId, configuration, tenantIdIn, jobDefinitionIdIn, sortBy, sortOrder, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;IncidentDto&gt;)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<List<IncidentDto>>> GetIncidentsWithHttpInfoAsync(string incidentId = default(string), string incidentType = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), string processDefinitionId = default(string), string processDefinitionKeyIn = default(string), string processInstanceId = default(string), string executionId = default(string), DateTime? incidentTimestampBefore = default(DateTime?), DateTime? incidentTimestampAfter = default(DateTime?), string activityId = default(string), string failedActivityId = default(string), string causeIncidentId = default(string), string rootCauseIncidentId = default(string), string configuration = default(string), string tenantIdIn = default(string), string jobDefinitionIdIn = default(string), string sortBy = default(string), string sortOrder = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <summary>
        /// Get List Count Queries for the number of incidents that fulfill given parameters. Takes the same parameters as the [Get Incidents](https://docs.camunda.org/manual/7.14/reference/rest/incident/get-query/) method.
        /// </summary>
        /// <exception cref="CamundaClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="incidentId">Restricts to incidents that have the given id. (optional)</param>
        /// <param name="incidentType">Restricts to incidents that belong to the given incident type. See the [User Guide](https://docs.camunda.org/manual/7.14/user-guide/process-engine/incidents/#incident-types) for a list of incident types. (optional)</param>
        ...
        /// <param name="jobDefinitionIdIn">Restricts to incidents that have one of the given comma-separated job definition ids. (optional)</param>
        /// <returns>ApiResponse of List&lt;CountResultDto&gt;</returns>
        public CamundaClient.Client.ApiResponse<List<CountResultDto>> GetIncidentsCountWithHttpInfo(string incidentId = default(string), string incidentType = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), string processDefinitionId = default(string), string processDefinitionKeyIn = default(string), string processInstanceId = default(string), string executionId = default(string), DateTime? incidentTimestampBefore = default(DateTime?), DateTime? incidentTimestampAfter = default(DateTime?), string activityId = default(string), string failedActivityId = default(string), string causeIncidentId = default(string), string rootCauseIncidentId = default(string), string configuration = default(string), string tenantIdIn = default(string), string jobDefinitionIdIn = default(string))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;CountResultDto&gt;)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<List<CountResultDto>>> GetIncidentsCountWithHttpInfoAsync(string incidentId = default(string), string incidentType = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), string processDefinitionId = default(string), string processDefinitionKeyIn = default(string), string processInstanceId = default(string), string executionId = default(string), DateTime? incidentTimestampBefore = default(DateTime?), DateTime? incidentTimestampAfter = default(DateTime?), string activityId = default(string), string failedActivityId = default(string), string causeIncidentId = default(string), string rootCauseIncidentId = default(string), string configuration = default(string), string tenantIdIn = default(string), string jobDefinitionIdIn = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="id">The id of the incident to be resolved.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> ResolveIncidentWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling IncidentApi->ResolveIncident");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> ResolveIncidentWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling IncidentApi->ResolveIncident");
