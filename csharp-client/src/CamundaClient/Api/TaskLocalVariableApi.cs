...
namespace CamundaClient.Api
{
    ...
    public partial class TaskLocalVariableApi : ITaskLocalVariableApi
    {
        ...
        /// <returns></returns>
        public TaskLocalVariableApi(CamundaClient.Client.Configuration configuration)
        {
        ...
        public TaskLocalVariableApi(CamundaClient.Client.ISynchronousClient client, CamundaClient.Client.IAsynchronousClient asyncClient, CamundaClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="varName">The name of the variable to be removed.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> DeleteTaskLocalVariableWithHttpInfo(string id, string varName)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->DeleteTaskLocalVariable");

            // verify the required parameter 'varName' is set
            if (varName == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'varName' when calling TaskLocalVariableApi->DeleteTaskLocalVariable");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> DeleteTaskLocalVariableWithHttpInfoAsync(string id, string varName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->DeleteTaskLocalVariable");
        ...
        {
            CamundaClient.Client.ApiResponse<VariableValueDto> localVarResponse = GetTaskLocalVariableWithHttpInfo(id, varName, deserializeValue);
        ...
        /// <param name="deserializeValue">Determines whether serializable variable values (typically variables that store custom Java objects) should be deserialized on the server side (default &#x60;true&#x60;).  If set to &#x60;true&#x60;, a serializable variable will be deserialized on server side and transformed to JSON using [Jackson&#39;s](https://github.com/FasterXML/jackson) POJO/bean property introspection feature. Note that this requires the Java classes of the variable value to be on the REST API&#39;s classpath.  If set to &#x60;false&#x60;, a serializable variable will be returned in its serialized format. For example, a variable that is serialized as XML will be returned as a JSON string containing XML.  Note: While &#x60;true&#x60; is the default value for reasons of backward compatibility, we recommend setting this parameter to &#x60;false&#x60; when developing web applications that are independent of the Java process applications deployed to the engine. (optional, default to true)</param>
        /// <returns>ApiResponse of VariableValueDto</returns>
        public CamundaClient.Client.ApiResponse<VariableValueDto> GetTaskLocalVariableWithHttpInfo(string id, string varName, bool? deserializeValue = default(bool?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->GetTaskLocalVariable");

            // verify the required parameter 'varName' is set
            if (varName == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'varName' when calling TaskLocalVariableApi->GetTaskLocalVariable");
        ...
        {
            CamundaClient.Client.ApiResponse<VariableValueDto> localVarResponse = await GetTaskLocalVariableWithHttpInfoAsync(id, varName, deserializeValue, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VariableValueDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<VariableValueDto>> GetTaskLocalVariableWithHttpInfoAsync(string id, string varName, bool? deserializeValue = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->GetTaskLocalVariable");
        ...
        {
            CamundaClient.Client.ApiResponse<System.IO.Stream> localVarResponse = GetTaskLocalVariableBinaryWithHttpInfo(id, varName);
            return localVarResponse.Data;
        }
        ...
        /// <param name="varName">The name of the variable to retrieve.</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public CamundaClient.Client.ApiResponse<System.IO.Stream> GetTaskLocalVariableBinaryWithHttpInfo(string id, string varName)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->GetTaskLocalVariableBinary");

            // verify the required parameter 'varName' is set
            if (varName == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'varName' when calling TaskLocalVariableApi->GetTaskLocalVariableBinary");
        ...
        {
            CamundaClient.Client.ApiResponse<System.IO.Stream> localVarResponse = await GetTaskLocalVariableBinaryWithHttpInfoAsync(id, varName, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<System.IO.Stream>> GetTaskLocalVariableBinaryWithHttpInfoAsync(string id, string varName, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->GetTaskLocalVariableBinary");
        ...
        {
            CamundaClient.Client.ApiResponse<Dictionary<string, VariableValueDto>> localVarResponse = GetTaskLocalVariablesWithHttpInfo(id, deserializeValues);
            return localVarResponse.Data;
        }
        ...
        /// <param name="deserializeValues">Determines whether serializable variable values (typically variables that store custom Java objects) should be deserialized on the server side (default &#x60;true&#x60;).  If set to &#x60;true&#x60;, a serializable variable will be deserialized on server side and transformed to JSON using [Jackson&#39;s](https://github.com/FasterXML/jackson) POJO/bean property introspection feature. Note that this requires the Java classes of the variable value to be on the REST API&#39;s classpath.  If set to &#x60;false&#x60;, a serializable variable will be returned in its serialized format. For example, a variable that is serialized as XML will be returned as a JSON string containing XML.  **Note:** While &#x60;true&#x60; is the default value for reasons of backward compatibility, we recommend setting this parameter to &#x60;false&#x60; when developing web applications that are independent of the Java process applications deployed to the engine. (optional, default to true)</param>
        /// <returns>ApiResponse of Dictionary&lt;string, VariableValueDto&gt;</returns>
        public CamundaClient.Client.ApiResponse<Dictionary<string, VariableValueDto>> GetTaskLocalVariablesWithHttpInfo(string id, bool? deserializeValues = default(bool?))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->GetTaskLocalVariables");
        ...
        {
            CamundaClient.Client.ApiResponse<Dictionary<string, VariableValueDto>> localVarResponse = await GetTaskLocalVariablesWithHttpInfoAsync(id, deserializeValues, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Dictionary&lt;string, VariableValueDto&gt;)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Dictionary<string, VariableValueDto>>> GetTaskLocalVariablesWithHttpInfoAsync(string id, bool? deserializeValues = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->GetTaskLocalVariables");
        ...
        /// <param name="patchVariablesDto"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> ModifyTaskLocalVariablesWithHttpInfo(string id, PatchVariablesDto patchVariablesDto = default(PatchVariablesDto))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->ModifyTaskLocalVariables");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> ModifyTaskLocalVariablesWithHttpInfoAsync(string id, PatchVariablesDto patchVariablesDto = default(PatchVariablesDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->ModifyTaskLocalVariables");
        ...
        /// <param name="variableValueDto"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> PutTaskLocalVariableWithHttpInfo(string id, string varName, VariableValueDto variableValueDto = default(VariableValueDto))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->PutTaskLocalVariable");

            // verify the required parameter 'varName' is set
            if (varName == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'varName' when calling TaskLocalVariableApi->PutTaskLocalVariable");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> PutTaskLocalVariableWithHttpInfoAsync(string id, string varName, VariableValueDto variableValueDto = default(VariableValueDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->PutTaskLocalVariable");
        ...
        /// <param name="valueType">The name of the variable type. Either Bytes for a byte array variable or File for a file variable. (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public CamundaClient.Client.ApiResponse<Object> SetBinaryTaskLocalVariableWithHttpInfo(string id, string varName, System.IO.Stream data = default(System.IO.Stream), string valueType = default(string))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->SetBinaryTaskLocalVariable");

            // verify the required parameter 'varName' is set
            if (varName == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'varName' when calling TaskLocalVariableApi->SetBinaryTaskLocalVariable");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<Object>> SetBinaryTaskLocalVariableWithHttpInfoAsync(string id, string varName, System.IO.Stream data = default(System.IO.Stream), string valueType = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new CamundaClient.Client.ApiException(400, "Missing required parameter 'id' when calling TaskLocalVariableApi->SetBinaryTaskLocalVariable");
