...
namespace CamundaClient.Api
{
    ...
    public partial class EventSubscriptionApi : IEventSubscriptionApi
    {
        ...
        /// <returns></returns>
        public EventSubscriptionApi(CamundaClient.Client.Configuration configuration)
        {
        ...
        public EventSubscriptionApi(CamundaClient.Client.ISynchronousClient client, CamundaClient.Client.IAsynchronousClient asyncClient, CamundaClient.Client.IReadableConfiguration configuration)
        {
        ...
        {
            CamundaClient.Client.ApiResponse<List<EventSubscriptionDto>> localVarResponse = GetEventSubscriptionsWithHttpInfo(eventSubscriptionId, eventName, eventType, executionId, processInstanceId, activityId, tenantIdIn, withoutTenantId, includeEventSubscriptionsWithoutTenantId, sortBy, sortOrder, firstResult, maxResults);
        ...
        /// <param name="maxResults">Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)</param>
        /// <returns>ApiResponse of List&lt;EventSubscriptionDto&gt;</returns>
        public CamundaClient.Client.ApiResponse<List<EventSubscriptionDto>> GetEventSubscriptionsWithHttpInfo(string eventSubscriptionId = default(string), string eventName = default(string), string eventType = default(string), string executionId = default(string), string processInstanceId = default(string), string activityId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? includeEventSubscriptionsWithoutTenantId = default(bool?), string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "eventSubscriptionId", eventSubscriptionId));
            }
            if (eventName != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "eventName", eventName));
            }
            if (eventType != null)
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "eventType", eventType));
            }
            if (executionId != null)
            {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(CamundaClient.Client.ClientUtils.ParameterToMultiMap("", "includeEventSubscriptionsWithoutTenantId", includeEventSubscriptionsWithoutTenantId));
            }
            if (sortBy != null)
            {
        ...
        {
            CamundaClient.Client.ApiResponse<List<EventSubscriptionDto>> localVarResponse = await GetEventSubscriptionsWithHttpInfoAsync(eventSubscriptionId, eventName, eventType, executionId, processInstanceId, activityId, tenantIdIn, withoutTenantId, includeEventSubscriptionsWithoutTenantId, sortBy, sortOrder, firstResult, maxResults, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;EventSubscriptionDto&gt;)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<List<EventSubscriptionDto>>> GetEventSubscriptionsWithHttpInfoAsync(string eventSubscriptionId = default(string), string eventName = default(string), string eventType = default(string), string executionId = default(string), string processInstanceId = default(string), string activityId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? includeEventSubscriptionsWithoutTenantId = default(bool?), string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            CamundaClient.Client.ApiResponse<CountResultDto> localVarResponse = GetEventSubscriptionsCountWithHttpInfo(eventSubscriptionId, eventName, eventType, executionId, processInstanceId, activityId, tenantIdIn, withoutTenantId, includeEventSubscriptionsWithoutTenantId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeEventSubscriptionsWithoutTenantId">Select event subscriptions which have no tenant id. Can be used in combination with tenantIdIn parameter. Value may only be &#x60;true&#x60;, as &#x60;false&#x60; is the default behavior. (optional)</param>
        /// <returns>ApiResponse of CountResultDto</returns>
        public CamundaClient.Client.ApiResponse<CountResultDto> GetEventSubscriptionsCountWithHttpInfo(string eventSubscriptionId = default(string), string eventName = default(string), string eventType = default(string), string executionId = default(string), string processInstanceId = default(string), string activityId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? includeEventSubscriptionsWithoutTenantId = default(bool?))
        {
            CamundaClient.Client.RequestOptions localVarRequestOptions = new CamundaClient.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CountResultDto)</returns>
        public async System.Threading.Tasks.Task<CamundaClient.Client.ApiResponse<CountResultDto>> GetEventSubscriptionsCountWithHttpInfoAsync(string eventSubscriptionId = default(string), string eventName = default(string), string eventType = default(string), string executionId = default(string), string processInstanceId = default(string), string activityId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? includeEventSubscriptionsWithoutTenantId = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
